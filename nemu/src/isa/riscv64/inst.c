...
static int decode_exec(Decode *s) {
  int rd = 0, rs1 = BITS(s->isa.inst.val, 19, 15);
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01100 11", sll    , R, R(rd) = src1 << shamt);
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(rd) = (uint64_t)SEXT(BITS((int64_t)BITS(src1, 31, 0) / (int64_t)BITS(src2, 31, 0), 31, 0), 32));
