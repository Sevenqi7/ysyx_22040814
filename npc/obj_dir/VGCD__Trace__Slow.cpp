...
void VGCD___024root__traceInitSub0(VGCD___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->declBit(c+77,"GCD.clock", false,-1);
        tracep->declBit(c+78,"GCD.reset", false,-1);
        tracep->declBus(c+79,"io_value1", false,-1, 15,0);
        tracep->declBus(c+80,"io_value2", false,-1, 15,0);
        tracep->declBit(c+81,"io_loadingValues", false,-1);
        tracep->declBus(c+82,"io_outputGCD", false,-1, 15,0);
        tracep->declBit(c+83,"io_outputValid", false,-1);
        tracep->declBit(c+84,"top.clock", false,-1);
        tracep->declBit(c+85,"top.reset", false,-1);
        tracep->declBus(c+86,"io_inst", false,-1, 31,0);
        tracep->declQuad(c+87,"io_IF_pc", false,-1, 63,0);
        tracep->declQuad(c+89,"io_ALUResult", false,-1, 63,0);
        tracep->declBit(c+77,"GCD clock", false,-1);
        tracep->declBit(c+78,"GCD reset", false,-1);
        tracep->declBus(c+79,"GCD io_value1", false,-1, 15,0);
        tracep->declBus(c+80,"GCD io_value2", false,-1, 15,0);
        tracep->declBit(c+81,"GCD io_loadingValues", false,-1);
        tracep->declBus(c+82,"GCD io_outputGCD", false,-1, 15,0);
        tracep->declBit(c+83,"GCD io_outputValid", false,-1);
        tracep->declBus(c+91,"GCD x", false,-1, 15,0);
        tracep->declBus(c+92,"GCD y", false,-1, 15,0);
        tracep->declBit(c+84,"top clock", false,-1);
        tracep->declBit(c+85,"top reset", false,-1);
        tracep->declBus(c+86,"top io_inst", false,-1, 31,0);
        tracep->declQuad(c+87,"top io_IF_pc", false,-1, 63,0);
        tracep->declQuad(c+89,"top io_ALUResult", false,-1, 63,0);
        tracep->declBit(c+84,"top inst_fetch_unit clock", false,-1);
        tracep->declBit(c+85,"top inst_fetch_unit reset", false,-1);
        tracep->declQuad(c+93,"top inst_fetch_unit io_IF_npc", false,-1, 63,0);
        tracep->declQuad(c+1,"top inst_fetch_unit io_IF_pc", false,-1, 63,0);
        tracep->declQuad(c+1,"top inst_fetch_unit pcReg", false,-1, 63,0);
        tracep->declBit(c+84,"top inst_decode_unit clock", false,-1);
        tracep->declBit(c+85,"top inst_decode_unit reset", false,-1);
        tracep->declBus(c+86,"top inst_decode_unit io_IF_Inst", false,-1, 31,0);
        ...
        tracep->declBus(c+95,"top inst_decode_unit io_EX_RegWriteID", false,-1, 4,0);
        tracep->declBit(c+69,"top inst_decode_unit io_EX_RegWriteEn", false,-1);
        tracep->declQuad(c+93,"top inst_decode_unit io_ID_npc", false,-1, 63,0);
        ...
        tracep->declBus(c+95,"top inst_decode_unit io_ID_RegWriteID", false,-1, 4,0);
        ...
        tracep->declBus(c+95,"top excute_unit io_ID_RegWriteID", false,-1, 4,0);
        tracep->declQuad(c+67,"top excute_unit io_EX_RegWriteData", false,-1, 63,0);
        tracep->declBus(c+95,"top excute_unit io_EX_RegWriteID", false,-1, 4,0);
        tracep->declBit(c+69,"top excute_unit io_EX_RegWriteEn", false,-1);
        tracep->declBus(c+86,"top simulate inst", false,-1, 31,0);
...
void VGCD___024root__traceFullSub0(VGCD___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+77,(vlSelf->GCD__02Eclock));
        tracep->fullBit(oldp+78,(vlSelf->GCD__02Ereset));
        tracep->fullSData(oldp+79,(vlSelf->io_value1),16);
        tracep->fullSData(oldp+80,(vlSelf->io_value2),16);
        tracep->fullBit(oldp+81,(vlSelf->io_loadingValues));
        tracep->fullSData(oldp+82,(vlSelf->io_outputGCD),16);
        tracep->fullBit(oldp+83,(vlSelf->io_outputValid));
        tracep->fullBit(oldp+84,(vlSelf->top__02Eclock));
        tracep->fullBit(oldp+85,(vlSelf->top__02Ereset));
        tracep->fullIData(oldp+86,(vlSelf->io_inst),32);
        tracep->fullQData(oldp+87,(vlSelf->io_IF_pc),64);
        tracep->fullQData(oldp+89,(vlSelf->io_ALUResult),64);
        tracep->fullSData(oldp+91,(vlSelf->GCD__DOT__x),16);
        tracep->fullSData(oldp+92,(vlSelf->GCD__DOT__y),16);
        tracep->fullQData(oldp+93,(((2U == (IData)(vlSelf->top__DOT__inst_decode_unit__DOT___GEN_0))
        ...
        tracep->fullCData(oldp+95,((0x1fU & (vlSelf->io_inst 
                                             >> 7U))),5);
    }
}
