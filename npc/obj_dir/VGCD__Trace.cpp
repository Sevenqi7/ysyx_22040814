...
void VGCD___024root__traceChgSub0(VGCD___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgBit(oldp+76,(vlSelf->GCD__02Eclock));
        tracep->chgBit(oldp+77,(vlSelf->GCD__02Ereset));
        tracep->chgSData(oldp+78,(vlSelf->io_value1),16);
        tracep->chgSData(oldp+79,(vlSelf->io_value2),16);
        tracep->chgBit(oldp+80,(vlSelf->io_loadingValues));
        tracep->chgSData(oldp+81,(vlSelf->io_outputGCD),16);
        tracep->chgBit(oldp+82,(vlSelf->io_outputValid));
        tracep->chgBit(oldp+83,(vlSelf->top__02Eclock));
        tracep->chgBit(oldp+84,(vlSelf->top__02Ereset));
        tracep->chgIData(oldp+85,(vlSelf->io_inst),32);
        tracep->chgQData(oldp+86,(vlSelf->io_IF_pc),64);
        tracep->chgQData(oldp+88,(vlSelf->io_ALUResult),64);
        tracep->chgSData(oldp+90,(vlSelf->GCD__DOT__x),16);
        tracep->chgSData(oldp+91,(vlSelf->GCD__DOT__y),16);
        tracep->chgQData(oldp+92,(((2U == (IData)(vlSelf->top__DOT__inst_decode_unit__DOT___GEN_0))
        ...
        tracep->chgCData(oldp+94,((0x1fU & (vlSelf->io_inst 
                                            >> 7U))),5);
    }
}
