...
VL_INLINE_OPT void VGCD___024root___sequent__TOP__2(VGCD___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VGCD__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VGCD___024root___sequent__TOP__2\n"); );
    // Variables
...
VL_INLINE_OPT void VGCD___024root___sequent__TOP__3(VGCD___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VGCD__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VGCD___024root___sequent__TOP__3\n"); );
    // Body
    vlSelf->top__DOT__inst_fetch_unit__DOT__pcReg = 
        ((IData)(vlSelf->top__02Ereset) ? 0x80000000ULL
          : vlSelf->top__DOT___inst_decode_unit_io_ID_npc);
    if (vlSelf->top__02Ereset) {
...
VL_INLINE_OPT void VGCD___024root___combo__TOP__4(VGCD___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VGCD__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VGCD___024root___combo__TOP__4\n"); );
    // Variables
...
void VGCD___024root___eval(VGCD___024root* vlSelf) {
    ...
    // Body
    if (((IData)(vlSelf->GCD__02Eclock) & (~ (IData)(vlSelf->__Vclklast__TOP__GCD__02Eclock)))) {
        VGCD___024root___sequent__TOP__2(vlSelf);
    }
    if (((IData)(vlSelf->top__02Eclock) & (~ (IData)(vlSelf->__Vclklast__TOP__top__02Eclock)))) {
        VGCD___024root___sequent__TOP__3(vlSelf);
        vlSelf->__Vm_traceActivity[1U] = 1U;
    }
    VGCD___024root___combo__TOP__4(vlSelf);
...
void VGCD___024root___eval_debug_assertions(VGCD___024root* vlSelf) {
    ...
    // Body
    if (VL_UNLIKELY((vlSelf->GCD__02Eclock & 0xfeU))) {
        Verilated::overWidthError("GCD.clock");}
    if (VL_UNLIKELY((vlSelf->GCD__02Ereset & 0xfeU))) {
        Verilated::overWidthError("GCD.reset");}
    if (VL_UNLIKELY((vlSelf->io_loadingValues & 0xfeU))) {
        Verilated::overWidthError("io_loadingValues");}
    if (VL_UNLIKELY((vlSelf->top__02Eclock & 0xfeU))) {
        Verilated::overWidthError("top.clock");}
