...
module BPU(	// <stdin>:207:10
  ...
  assign io_bp_taken = _GEN;	// <stdin>:207:10, bpu.scala:181:18, :182:55, :183:18
  assign io_bp_flush = _io_bp_flush_T_1;	// <stdin>:207:10, bpu.scala:168:49
  assign io_bp_npc = _io_bp_flush_T_1 ? io_ID_to_BPU_bus_bits_br_target : _GEN ? _BTB_io_readData :
                _io_bp_npc_T_1;	// <stdin>:207:10, Mux.scala:101:16, bpu.scala:150:21, :168:49, :169:43, :181:18, :182:55, :183:18
  assign io_BTB_rdata = _BTB_io_readData;	// <stdin>:207:10, bpu.scala:150:21
  assign io_BTB_wdata = io_ID_to_BPU_bus_bits_taken ? io_ID_to_BPU_bus_bits_br_target : 64'h0;	// <stdin>:207:10, bpu.scala:141:28, :165:29
  assign io_BTB_hit = _BTB_io_hit;	// <stdin>:207:10, bpu.scala:150:21
  assign io_br_cnt = br_cnt;	// <stdin>:207:10, bpu.scala:205:26
  assign io_bp_fail = bp_fail;	// <stdin>:207:10, bpu.scala:206:26
  assign io_hit_cnt = hit_cnt;	// <stdin>:207:10, bpu.scala:207:26
endmodule
...
module RAMU(	// <stdin>:2338:10
  ...
  wire       _data_ram_arready;	// top.scala:192:26
  wire       _data_ram_awready;	// top.scala:192:26
  wire       _data_ram_wready;	// top.scala:192:26
  wire [1:0] _data_ram_bresp;	// top.scala:192:26
  wire       _data_ram_bvalid;	// top.scala:192:26
  sim_sram data_ram (	// top.scala:192:26
    .pc      (64'h0),	// top.scala:195:45
    .aclk    (clock),
    .aresetn (~reset),	// top.scala:198:48
...
module AXI_Arbiter(	// <stdin>:2387:10
  ...
  assign in_0_readData_bits_data = req_0_valid ? out_readData_bits_data : 64'h77;	// <stdin>:2387:10, top.scala:174:37, :180:27, :181:17
  ...
  assign req_1_ready = ~req_0_valid;	// <stdin>:2387:10, top.scala:180:27, :184:30
  assign out_writeAddr_valid = req_0_valid & in_0_writeAddr_valid;	// <stdin>:2387:10, top.scala:180:27, :181:17
  assign out_writeAddr_bits_addr = req_0_valid ? in_0_writeAddr_bits_addr : 32'h0;	// <stdin>:2387:10, top.scala:180:27, :181:17
  assign out_writeData_valid = req_0_valid & in_0_writeData_valid;	// <stdin>:2387:10, top.scala:180:27, :181:17
  assign out_writeData_bits_data = req_0_valid ? in_0_writeData_bits_data : 64'h0;	// <stdin>:2387:10, top.scala:180:27, :181:17
  assign out_writeData_bits_strb = req_0_valid ? in_0_writeData_bits_strb : 8'h0;	// <stdin>:2387:10, top.scala:180:27, :181:17
  assign out_writeResp_ready = req_0_valid & in_0_writeResp_ready;	// <stdin>:2387:10, top.scala:180:27, :181:17
  assign out_readAddr_valid = req_0_valid ? in_0_readAddr_valid : in_1_readAddr_valid;	// <stdin>:2387:10, top.scala:180:27, :181:17
  assign out_readAddr_bits_addr = req_0_valid ? in_0_readAddr_bits_addr : in_1_readAddr_bits_addr;	// <stdin>:2387:10, top.scala:180:27, :181:17
  assign out_readData_ready = req_0_valid ? in_0_readData_ready : in_1_readData_ready;	// <stdin>:2387:10, top.scala:180:27, :181:17
endmodule
...
sim simulate (	// top.scala:24:26
  ...
  assign io_ID_npc = _inst_decode_unit_io_ID_to_BPU_bus_bits_br_target;	// <stdin>:2421:10, top.scala:66:34
  assign io_PF_pc = _inst_fetch_unit_io_PF_pc;	// <stdin>:2421:10, top.scala:65:33
  assign io_PF_axidata = _inst_fetch_unit_io_axidata;	// <stdin>:2421:10, top.scala:65:33
  assign io_IF_pc = _inst_fetch_unit_io_IF_to_ID_bus_bits_PC;	// <stdin>:2421:10, top.scala:65:33
  assign io_ID_pc = _inst_decode_unit_io_ID_to_EX_bus_bits_PC;	// <stdin>:2421:10, top.scala:66:34
  assign io_EX_pc = _excute_unit_io_EX_to_MEM_bus_bits_PC;	// <stdin>:2421:10, top.scala:67:29
  assign io_PMEM_pc = _pre_mem_unit_io_PMEM_to_MEM_bus_bits_PC;	// <stdin>:2421:10, top.scala:68:30
  assign io_WB_Inst = _wb_unit_io_WB_Inst;	// <stdin>:2421:10, top.scala:70:25
  assign io_WB_RegWriteData = _wb_unit_io_WB_to_ID_forward_bits_regWriteData;	// <stdin>:2421:10, top.scala:70:25
  assign io_WB_RegWriteID = {59'h0, _wb_unit_io_WB_to_ID_forward_bits_regWriteID};	// <stdin>:2421:10, top.scala:70:25, :102:24
  assign io_MEM_RegWriteData = _arb_in_0_readData_bits_data;	// <stdin>:2421:10, top.scala:153:21
  assign io_bp_npc = _bp_unit_io_bp_npc;	// <stdin>:2421:10, top.scala:64:33
  assign io_bp_taken = _bp_unit_io_bp_taken;	// <stdin>:2421:10, top.scala:64:33
  assign io_bp_flush = _bp_unit_io_bp_flush;	// <stdin>:2421:10, top.scala:64:33
  assign io_IF_Inst = _inst_fetch_unit_io_IF_to_ID_bus_bits_Inst;	// <stdin>:2421:10, top.scala:65:33
  assign io_IF_valid = _inst_fetch_unit_io_IF_to_ID_bus_valid;	// <stdin>:2421:10, top.scala:65:33
  assign io_IF_AXIREQ = _arb_req_1_ready;	// <stdin>:2421:10, top.scala:153:21
  assign io_ID_ALU_Data1 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data1;	// <stdin>:2421:10, top.scala:66:34
  assign io_ID_ALU_Data2 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data2;	// <stdin>:2421:10, top.scala:66:34
  assign io_ID_Rs2Data = _inst_decode_unit_io_ID_to_EX_bus_bits_rs2_data;	// <stdin>:2421:10, top.scala:66:34
  assign io_ALUResult = _excute_unit_io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:2421:10, top.scala:67:29
endmodule
