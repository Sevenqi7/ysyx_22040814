...
module IDU(	// <stdin>:1782:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      rhsReg_5 <= 1'h0;	// Lookup.scala:34:39, tools.scala:23:29
      rhsReg_6 <= 1'h0;	// Lookup.scala:34:39, tools.scala:23:29
      rhsReg_7 <= 1'h0;	// Lookup.scala:34:39, tools.scala:23:29
      ...
      rhsReg_14 <= 1'h0;	// Lookup.scala:34:39, tools.scala:23:29
      rhsReg_15 <= 64'h0;	// IDU.scala:119:30, tools.scala:23:29
      rhsReg_16 <= 1'h0;	// Lookup.scala:34:39, tools.scala:23:29
    end
    else begin
      ...
      if (~_io_ID_to_BPU_bus_bits_stall_T) begin	// IDU.scala:209:35
        ...
        rhsReg_9 <= {1'h0, InstInfo_1};	// IDU.scala:97:21, Lookup.scala:34:39, tools.scala:23:29
        if (_rs1_data_T)	// IDU.scala:136:15
          rhsReg_10 <= 64'h0;	// IDU.scala:119:30, tools.scala:23:29
        else if (_rs1_data_T_2)	// IDU.scala:136:15, :137:53
  ...
  `ifndef SYNTHESIS	// <stdin>:1782:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_IF_to_ID_bus_ready = ~_io_ID_to_BPU_bus_bits_stall_T;	// <stdin>:1782:10, IDU.scala:209:35, tools.scala:24:18
  ...
  assign io_ID_to_BPU_bus_valid = io_IF_to_ID_bus_valid & (_io_ID_to_BPU_bus_valid_T | _io_ID_to_BPU_bus_valid_T_1 |
                ...
                _io_ID_to_BPU_bus_valid_T_8) & ~_load_use_stall_T_22 & ~_csr_stall_T_12;	// <stdin>:1782:10, IDU.scala:172:19, :173:19, :182:15, :194:104, :198:35, :201:37, :241:65, :251:28, :299:{62,80,144,160,162}
  assign io_ID_to_BPU_bus_bits_PC = io_IF_to_ID_bus_bits_PC;	// <stdin>:1782:10
  assign io_ID_to_BPU_bus_bits_taken = _io_ID_to_BPU_bus_valid_T | (_io_ID_to_BPU_bus_valid_T_1 ? _GEN_12 :
                _io_ID_to_BPU_bus_valid_T_3 & _io_ID_to_BPU_bus_valid_T_4);	// <stdin>:1782:10, IDU.scala:172:19, :173:19, :182:15, :194:104, :263:19, :264:34, :273:15, :274:21, :275:31, :276:31, :277:31
  assign io_ID_to_BPU_bus_bits_br_target = _io_ID_to_BPU_bus_valid_T ? io_IF_to_ID_bus_bits_PC + {{44{io_IF_to_ID_bus_bits_Inst[31]}},
                ...
                _io_ID_to_BPU_bus_valid_T_8 ? io_CSR_csrReadData : {32'h0, _ALU_Data1_T_5[31:0]};	// <stdin>:1782:10, Bitwise.scala:77:12, IDU.scala:109:25, :112:{25,44,66,92}, :113:{48,72,90}, :172:19, :173:19, :182:{15,30}, :194:104, :198:35, :201:37, :263:19, :264:34, :289:13, :291:37, :292:{31,50}, :293:{31,58}, :294:39, Lookup.scala:34:39, Mux.scala:101:16
  ...
  assign io_ID_to_BPU_bus_bits_Type = _io_ID_to_BPU_bus_valid_T ? 2'h1 : _io_ID_to_BPU_bus_valid_T_1 ? 2'h2 :
                _io_ID_to_BPU_bus_valid_T_3 ? {2{_io_ID_to_BPU_bus_valid_T_4}} : 2'h0;	// <stdin>:1782:10, IDU.scala:172:19, :173:19, :182:15, :194:104, :281:10, :282:21, :283:27, :284:27, :285:{27,33}, Lookup.scala:34:39
  ...
  assign io_ID_stall = _io_ID_to_BPU_bus_bits_stall_T;	// <stdin>:1782:10, IDU.scala:209:35
  ...
  assign io_ID_unknown_inst = InstInfo_0 == 4'h0 & io_IF_to_ID_bus_valid;	// <stdin>:1782:10, IDU.scala:234:{36,44}, Lookup.scala:34:39
endmodule
...
module MEM_pre_stage(	// <stdin>:3045:10
  ...
  assign io_memReadData = rhsReg_8 == 5'h11 ? axi_readData_bits_data : rhsReg_8 == 5'h9 ?
                ...
                rhsReg_8 == 5'h2 ? {56'h0, axi_readData_bits_data[7:0]} : 64'h0;	// <stdin>:3045:10, Bitwise.scala:77:12, Cat.scala:33:92, PMEM.scala:59:20, :67:17, :68:44, :69:30, :70:{30,60}, :71:{30,60}, :72:{30,60}, :73:{30,55}, :74:{30,55}, :75:{30,55}, tools.scala:9:34, :15:29
