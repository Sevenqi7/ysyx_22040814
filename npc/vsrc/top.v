...
module RAMU(	// <stdin>:3316:10
  ...
  sim_sram data_ram (	// RAM.scala:87:26
    ...
    .arburst (2'h1),	// <stdin>:3316:10
    .arlock  (2'h0),	// <stdin>:3316:10
    .arcache (4'h0),	// <stdin>:3316:10
    .arprot  (3'h0),	// <stdin>:3316:10
    .arvalid (axi_readAddr_valid),
    .rready  (axi_readData_ready),
    .awid    (axi_writeAddr_bits_id),
    .awaddr  (axi_writeAddr_bits_addr),
    .awlen   (8'h0),	// <stdin>:3316:10
    .awsize  (3'h0),	// <stdin>:3316:10
    .awburst (2'h0),	// <stdin>:3316:10
    .awlock  (2'h0),	// <stdin>:3316:10
    .awcache (4'h0),	// <stdin>:3316:10
    .awprot  (3'h0),	// <stdin>:3316:10
    .awvalid (axi_writeAddr_valid),
    .wid     ({3'h0, axi_writeData_bits_id}),	// <stdin>:3316:10, RAM.scala:124:45
    .wdata   (axi_writeData_bits_data),
    .wstrb   (axi_writeData_bits_strb),
    .wlast   (1'h1),	// <stdin>:3316:10
...
module AXI_Arbiter(	// <stdin>:3403:10
  ...
  assign in_0_readData_bits_data = req_0_valid ? out_readData_bits_data : 64'h77;	// <stdin>:3403:10, RAM.scala:66:37, :75:27, :76:17
  assign in_1_readAddr_ready = out_readAddr_ready;	// <stdin>:3403:10
  assign in_1_readData_bits_data = out_readData_bits_data;	// <stdin>:3403:10
  assign in_1_readData_bits_last = out_readData_bits_last;	// <stdin>:3403:10
  assign req_0_ready = req_0_valid;	// <stdin>:3403:10
  assign req_1_ready = ~req_0_valid;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_writeAddr_valid = req_0_valid & in_0_writeAddr_valid;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_writeAddr_bits_addr = req_0_valid ? in_0_writeAddr_bits_addr : 32'h0;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_writeAddr_bits_id = _GEN;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_writeData_valid = req_0_valid & in_0_writeData_valid;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_writeData_bits_data = req_0_valid ? in_0_writeData_bits_data : 64'h0;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_writeData_bits_id = req_0_valid;	// <stdin>:3403:10
  assign out_writeData_bits_strb = req_0_valid ? in_0_writeData_bits_strb : 8'h0;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_writeResp_ready = req_0_valid & in_0_writeResp_ready;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_readAddr_valid = req_0_valid ? in_0_readAddr_valid : in_1_readAddr_valid;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_readAddr_bits_addr = req_0_valid ? in_0_readAddr_bits_addr : in_1_readAddr_bits_addr;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_readAddr_bits_size = req_0_valid ? 3'h6 : 3'h3;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_readAddr_bits_len = {6'h0, ~req_0_valid, 1'h0};	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_readAddr_bits_id = _GEN;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
  assign out_readData_ready = req_0_valid ? in_0_readData_ready : in_1_readData_ready;	// <stdin>:3403:10, RAM.scala:75:27, :76:17
endmodule

module top(	// <stdin>:3443:10
  input          clock,
                 reset,
...
sim simulate (	// top.scala:24:26
  ...
  assign io_ID_npc = _inst_decode_unit_io_ID_to_BPU_bus_bits_br_target;	// <stdin>:3443:10, top.scala:96:34
  assign io_PF_pc = _inst_fetch_unit_io_PF_pc;	// <stdin>:3443:10, top.scala:95:33
  assign io_PF_axidata = _arb_in_1_readData_bits_data;	// <stdin>:3443:10, top.scala:215:21
  assign io_IF_pc = _inst_fetch_unit_io_IF_to_ID_bus_bits_PC;	// <stdin>:3443:10, top.scala:95:33
  assign io_ID_pc = _inst_decode_unit_io_ID_to_EX_bus_bits_PC;	// <stdin>:3443:10, top.scala:96:34
  assign io_EX_pc = _excute_unit_io_EX_to_MEM_bus_bits_PC;	// <stdin>:3443:10, top.scala:97:29
  assign io_PMEM_pc = _pre_mem_unit_io_PMEM_to_MEM_bus_bits_PC;	// <stdin>:3443:10, top.scala:98:30
  assign io_WB_Inst = _wb_unit_io_WB_Inst;	// <stdin>:3443:10, top.scala:100:25
  assign io_WB_RegWriteData = _wb_unit_io_WB_to_ID_forward_bits_regWriteData;	// <stdin>:3443:10, top.scala:100:25
  assign io_WB_RegWriteID = {59'h0, _wb_unit_io_WB_to_ID_forward_bits_regWriteID};	// <stdin>:3443:10, top.scala:100:25, :153:24
  assign io_MEM_RegWriteData = _arb_in_0_readData_bits_data;	// <stdin>:3443:10, top.scala:215:21
  assign io_bp_npc = _bp_unit_io_bp_npc;	// <stdin>:3443:10, top.scala:94:33
  assign io_bp_taken = _bp_unit_io_bp_taken;	// <stdin>:3443:10, top.scala:94:33
  assign io_bp_flush = _bp_unit_io_bp_flush;	// <stdin>:3443:10, top.scala:94:33
  assign io_csrWriteEn = _mem_unit_io_MEM_to_WB_bus_bits_csrWriteEn;	// <stdin>:3443:10, top.scala:99:26
  assign io_csrWriteAddr = _mem_unit_io_MEM_to_WB_bus_bits_csrWriteAddr;	// <stdin>:3443:10, top.scala:99:26
  assign io_csrWriteData = _mem_unit_io_MEM_to_WB_bus_bits_csrWriteData;	// <stdin>:3443:10, top.scala:99:26
  assign io_EX_csrWriteData = _excute_unit_io_EX_to_MEM_bus_bits_csrWriteData;	// <stdin>:3443:10, top.scala:97:29
  assign io_cache_axi_req = _inst_fetch_unit_axi_readAddr_valid;	// <stdin>:3443:10, top.scala:95:33
  assign io_cache_rlast = _arb_in_1_readData_bits_last;	// <stdin>:3443:10, top.scala:215:21
  assign io_IF_Inst = _inst_fetch_unit_io_IF_to_ID_bus_bits_Inst;	// <stdin>:3443:10, top.scala:95:33
  assign io_IF_valid = _inst_fetch_unit_io_IF_to_ID_bus_valid;	// <stdin>:3443:10, top.scala:95:33
  assign io_IF_AXIREQ = _arb_req_1_ready;	// <stdin>:3443:10, top.scala:215:21
  assign io_ID_ALU_Data1 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data1;	// <stdin>:3443:10, top.scala:96:34
  assign io_ID_ALU_Data2 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data2;	// <stdin>:3443:10, top.scala:96:34
  assign io_EX_ALU_result_pass = _excute_unit_io_EX_ALUResult_Pass;	// <stdin>:3443:10, top.scala:97:29
  assign io_ID_Rs2Data = _inst_decode_unit_io_ID_to_EX_bus_bits_rs2_data;	// <stdin>:3443:10, top.scala:96:34
  assign io_ALUResult = _excute_unit_io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:3443:10, top.scala:97:29
endmodule
