...
module IDU(	// <stdin>:1782:10
  ...
  `ifndef SYNTHESIS	// <stdin>:1782:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_IF_to_ID_bus_ready = ~_io_ID_stall_T;	// <stdin>:1782:10, IDU.scala:71:20, :210:35
  ...
  assign io_ID_to_BPU_bus_valid = io_IF_to_ID_bus_valid & (_io_ID_to_BPU_bus_valid_T | _io_ID_to_BPU_bus_valid_T_1 |
                ...
                _io_ID_to_BPU_bus_valid_T_8) & ~_io_ID_stall_T;	// <stdin>:1782:10, IDU.scala:71:20, :173:19, :174:19, :183:15, :195:104, :199:35, :202:37, :210:35, :301:{62,80,142}
  assign io_ID_to_BPU_bus_bits_PC = IF_pc;	// <stdin>:1782:10, IDU.scala:74:20
  assign io_ID_to_BPU_bus_bits_taken = _io_ID_to_BPU_bus_valid_T | (_io_ID_to_BPU_bus_valid_T_1 ? _GEN_12 :
                _io_ID_to_BPU_bus_valid_T_3 & _io_ID_to_BPU_bus_valid_T_4);	// <stdin>:1782:10, IDU.scala:173:19, :174:19, :183:15, :195:104, :265:19, :266:34, :275:15, :276:21, :277:31, :278:31, :279:31
  assign io_ID_to_BPU_bus_bits_br_target = _io_ID_to_BPU_bus_valid_T ? IF_pc + {{44{io_IF_to_ID_bus_bits_Inst[31]}},
                ...
                _io_ID_to_BPU_bus_valid_T_8 ? io_CSR_csrReadData : {32'h0, _ALU_Data1_T_5[31:0]};	// <stdin>:1782:10, Bitwise.scala:77:12, IDU.scala:71:20, :74:20, :110:25, :113:{25,44,66,92}, :114:{48,72,90}, :173:19, :174:19, :183:{15,30}, :195:104, :199:35, :202:37, :265:19, :266:34, :291:13, :293:37, :294:{31,50}, :295:{31,58}, :296:39, Mux.scala:101:16
  assign io_ID_to_BPU_bus_bits_stall = _io_ID_stall_T;	// <stdin>:1782:10, IDU.scala:210:35
  assign io_ID_to_BPU_bus_bits_Type = _io_ID_to_BPU_bus_valid_T ? 2'h1 : _io_ID_to_BPU_bus_valid_T_1 ? 2'h2 :
                _io_ID_to_BPU_bus_valid_T_3 ? {2{_io_ID_to_BPU_bus_valid_T_4}} : 2'h0;	// <stdin>:1782:10, IDU.scala:173:19, :174:19, :183:15, :195:104, :283:10, :284:21, :285:27, :286:27, :287:{27,33}, Lookup.scala:34:39
  assign io_ID_csrReadAddr = _GEN_11;	// <stdin>:1782:10, Mux.scala:101:16
  assign io_ID_ecall = _io_ID_to_BPU_bus_valid_T_7;	// <stdin>:1782:10, IDU.scala:199:35
  assign io_ID_stall = _io_ID_stall_T;	// <stdin>:1782:10, IDU.scala:210:35
  assign io_ID_GPR_0 = GPR_0;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_1 = GPR_1;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_2 = GPR_2;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_3 = GPR_3;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_4 = GPR_4;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_5 = GPR_5;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_6 = GPR_6;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_7 = GPR_7;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_8 = GPR_8;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_9 = GPR_9;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_10 = GPR_10;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_11 = GPR_11;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_12 = GPR_12;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_13 = GPR_13;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_14 = GPR_14;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_15 = GPR_15;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_16 = GPR_16;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_17 = GPR_17;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_18 = GPR_18;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_19 = GPR_19;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_20 = GPR_20;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_21 = GPR_21;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_22 = GPR_22;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_23 = GPR_23;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_24 = GPR_24;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_25 = GPR_25;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_26 = GPR_26;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_27 = GPR_27;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_28 = GPR_28;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_29 = GPR_29;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_30 = GPR_30;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_GPR_31 = GPR_31;	// <stdin>:1782:10, IDU.scala:120:22
  assign io_ID_unknown_inst = InstInfo_0 == 4'h0 & io_IF_to_ID_bus_valid;	// <stdin>:1782:10, IDU.scala:236:{36,44}, Lookup.scala:34:39
endmodule

module EXU(	// <stdin>:2753:10
  input         clock,
                reset,
                io_ID_to_EX_bus_valid,
  ...
  `ifndef SYNTHESIS	// <stdin>:2753:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2753:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2753:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:2753:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:2753:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2753:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2753:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2753:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_8 = `RANDOM;	// <stdin>:2753:10
        _RANDOM_9 = `RANDOM;	// <stdin>:2753:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2753:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2753:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_EX_to_MEM_bus_valid = rhsReg_12;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_Inst = rhsReg_1;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_PC = rhsReg;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_ALU_result = rhsReg_8;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_memWriteData = rhsReg_6;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_memWriteEn = rhsReg_4;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_memReadEn = rhsReg_5;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_lsutype = rhsReg_7;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_regWriteID = rhsReg_3;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_regWriteEn = rhsReg_2;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_csrWriteEn = rhsReg_9;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_csrWriteAddr = rhsReg_10;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_to_MEM_bus_bits_csrWriteData = rhsReg_11;	// <stdin>:2753:10, tools.scala:23:29
  assign io_EX_ALUResult_Pass = _GEN_5;	// <stdin>:2753:10, Mux.scala:101:16
endmodule

module MEM_pre_stage(	// <stdin>:3077:10
  input         clock,
                reset,
  ...
  `ifndef SYNTHESIS	// <stdin>:3077:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3077:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3077:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:3077:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:3077:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3077:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3077:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3077:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_4 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_5 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_6 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_7 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_8 = `RANDOM;	// <stdin>:3077:10
        _RANDOM_9 = `RANDOM;	// <stdin>:3077:10
        rhsReg = {_RANDOM_0, _RANDOM_1};	// tools.scala:15:29
        rhsReg_1 = _RANDOM_2;	// tools.scala:15:29
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3077:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3077:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_PMEM_to_MEM_bus_valid = rhsReg_12;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_ALU_result = rhsReg_2;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_regWriteEn = rhsReg_3;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_regWriteID = rhsReg_4;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_memReadEn = rhsReg_5;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_csrWriteAddr = rhsReg_10;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_csrWriteEn = rhsReg_9;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_csrWriteData = rhsReg_11;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_PC = rhsReg;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_Inst = rhsReg_1;	// <stdin>:3077:10, tools.scala:15:29
  assign io_PMEM_to_ID_forward_valid = io_EX_to_MEM_bus_valid;	// <stdin>:3077:10
  assign io_PMEM_to_ID_forward_bits_ALU_result = io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:3077:10
  assign io_PMEM_to_ID_forward_bits_regWriteEn = io_EX_to_MEM_bus_bits_regWriteEn;	// <stdin>:3077:10
  assign io_PMEM_to_ID_forward_bits_regWriteID = io_EX_to_MEM_bus_bits_regWriteID;	// <stdin>:3077:10
  assign io_PMEM_to_ID_forward_bits_memReadEn = io_EX_to_MEM_bus_bits_memReadEn;	// <stdin>:3077:10
  assign io_PMEM_to_ID_forward_bits_csrWriteAddr = io_EX_to_MEM_bus_bits_csrWriteAddr;	// <stdin>:3077:10
  assign io_PMEM_to_ID_forward_bits_csrWriteEn = io_EX_to_MEM_bus_bits_csrWriteEn;	// <stdin>:3077:10
  assign io_memReadData = rhsReg_8 == 5'h11 ? axi_readData_bits_data : rhsReg_8 == 5'h9 ?
                ...
                rhsReg_8 == 5'h2 ? {56'h0, axi_readData_bits_data[7:0]} : 64'h0;	// <stdin>:3077:10, Bitwise.scala:77:12, Cat.scala:33:92, PMEM.scala:43:28, :59:20, :67:17, :68:44, :69:30, :70:{30,60}, :71:{30,60}, :72:{30,60}, :73:{30,55}, :74:{30,55}, :75:{30,55}, tools.scala:9:34, :15:29
  assign axi_writeAddr_valid = io_EX_to_MEM_bus_bits_memWriteEn;	// <stdin>:3077:10
  assign axi_writeAddr_bits_addr = io_EX_to_MEM_bus_bits_ALU_result[31:0];	// <stdin>:3077:10, PMEM.scala:98:53
  assign axi_writeData_valid = io_EX_to_MEM_bus_bits_memWriteEn;	// <stdin>:3077:10
  assign axi_writeData_bits_data = io_EX_to_MEM_bus_bits_memWriteData;	// <stdin>:3077:10
  assign axi_writeData_bits_strb = io_EX_to_MEM_bus_bits_lsutype == 5'h10 ? 8'hFF : io_EX_to_MEM_bus_bits_lsutype == 5'h8 ?
                ...
                == 5'h2};	// <stdin>:3077:10, PMEM.scala:58:11, :59:20, :60:24, :61:24, :62:24, :63:24
  assign axi_writeResp_ready = io_EX_to_MEM_bus_bits_memWriteEn;	// <stdin>:3077:10
  assign axi_readAddr_valid = io_EX_to_MEM_bus_bits_memReadEn;	// <stdin>:3077:10
  assign axi_readAddr_bits_addr = io_EX_to_MEM_bus_bits_ALU_result[31:0];	// <stdin>:3077:10, PMEM.scala:98:53
  assign axi_readData_ready = io_EX_to_MEM_bus_bits_memReadEn;	// <stdin>:3077:10
  assign axi_req_valid = (|io_EX_to_MEM_bus_bits_lsutype) | (|rhsReg_8);	// <stdin>:3077:10, PMEM.scala:56:{34,41,76}, tools.scala:15:29
endmodule

module MEMU(	// <stdin>:3251:10
  input         clock,
                reset,
  ...
  `ifndef SYNTHESIS	// <stdin>:3251:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3251:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3251:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3251:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3251:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3251:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3251:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3251:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:3251:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:3251:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:3251:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:3251:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3251:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3251:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3251:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3251:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3251:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3251:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3251:10
        _RANDOM_4 = `RANDOM;	// <stdin>:3251:10
        _RANDOM_5 = `RANDOM;	// <stdin>:3251:10
        _RANDOM_6 = `RANDOM;	// <stdin>:3251:10
        _RANDOM_7 = `RANDOM;	// <stdin>:3251:10
        rhsReg = {_RANDOM_0, _RANDOM_1};	// tools.scala:15:29
        rhsReg_1 = _RANDOM_2;	// tools.scala:15:29
        rhsReg_2 = _RANDOM_3[0];	// tools.scala:15:29
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3251:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3251:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_MEM_to_WB_bus_valid = rhsReg_8;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteData = rhsReg_4;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteEn = rhsReg_2;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteID = rhsReg_3;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_csrWriteEn = rhsReg_5;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_csrWriteAddr = rhsReg_6;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_csrWriteData = rhsReg_7;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_PC = rhsReg;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_Inst = rhsReg_1;	// <stdin>:3251:10, tools.scala:15:29
  assign io_MEM_to_ID_forward_valid = io_PMEM_to_MEM_bus_bits_regWriteEn & (|io_PMEM_to_MEM_bus_bits_regWriteID) &
                io_PMEM_to_MEM_bus_valid;	// <stdin>:3251:10, MEMU.scala:74:{72,79}
  assign io_MEM_to_ID_forward_bits_regWriteData = io_PMEM_to_MEM_bus_bits_memReadEn ? io_memReadData : io_PMEM_to_MEM_bus_bits_ALU_result;	// <stdin>:3251:10, MEMU.scala:54:24
  assign io_MEM_to_ID_forward_bits_regWriteEn = io_PMEM_to_MEM_bus_bits_regWriteEn;	// <stdin>:3251:10
  assign io_MEM_to_ID_forward_bits_regWriteID = io_PMEM_to_MEM_bus_bits_regWriteID;	// <stdin>:3251:10
  assign io_MEM_to_ID_forward_bits_csrWriteEn = io_PMEM_to_MEM_bus_bits_csrWriteEn;	// <stdin>:3251:10
  assign io_MEM_to_ID_forward_bits_csrWriteAddr = io_PMEM_to_MEM_bus_bits_csrWriteAddr;	// <stdin>:3251:10
endmodule

module WBU(	// <stdin>:3307:10
  ...
  assign io_WB_to_ID_forward_valid = io_MEM_to_WB_bus_valid;	// <stdin>:3307:10
  assign io_WB_to_ID_forward_bits_regWriteData = io_MEM_to_WB_bus_bits_regWriteData;	// <stdin>:3307:10
  assign io_WB_to_ID_forward_bits_regWriteEn = io_MEM_to_WB_bus_bits_regWriteEn;	// <stdin>:3307:10
  assign io_WB_to_ID_forward_bits_regWriteID = io_MEM_to_WB_bus_bits_regWriteID;	// <stdin>:3307:10
  assign io_WB_to_ID_forward_bits_csrWriteEn = io_MEM_to_WB_bus_bits_csrWriteEn;	// <stdin>:3307:10
  assign io_WB_to_ID_forward_bits_csrWriteAddr = io_MEM_to_WB_bus_bits_csrWriteAddr;	// <stdin>:3307:10
  assign io_WB_pc = io_MEM_to_WB_bus_valid ? io_MEM_to_WB_bus_bits_PC : 64'h0;	// <stdin>:3307:10, WBU.scala:31:30
  assign io_WB_Inst = io_MEM_to_WB_bus_bits_Inst;	// <stdin>:3307:10
endmodule

module CSR(	// <stdin>:3323:10
  input         clock,
                reset,
                io_ID_ecall,
                io_writeEn,
  ...
  `ifndef SYNTHESIS	// <stdin>:3323:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:3323:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:3323:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:3323:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:3323:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:3323:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:3323:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:3323:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:3323:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:3323:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:3323:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:3323:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:3323:10
        `INIT_RANDOM_PROLOG_	// <stdin>:3323:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:3323:10
        _RANDOM_0 = `RANDOM;	// <stdin>:3323:10
        _RANDOM_1 = `RANDOM;	// <stdin>:3323:10
        _RANDOM_2 = `RANDOM;	// <stdin>:3323:10
        _RANDOM_3 = `RANDOM;	// <stdin>:3323:10
        _RANDOM_4 = `RANDOM;	// <stdin>:3323:10
        _RANDOM_5 = `RANDOM;	// <stdin>:3323:10
        _RANDOM_6 = `RANDOM;	// <stdin>:3323:10
        _RANDOM_7 = `RANDOM;	// <stdin>:3323:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:3323:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:3323:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_readData = io_readAddr == 12'h300 ? mstatus : io_readAddr == 12'h305 ? mtvec : io_readAddr == 12'h341
                ? mepc : io_readAddr == 12'h342 ? mcause : 64'h0;	// <stdin>:3323:10, CSR.scala:20:26, :21:26, :22:26, :23:26, :30:17, :31:24, :32:37, :33:37, :34:37, :35:37
  assign io_mstatus = mstatus;	// <stdin>:3323:10, CSR.scala:20:26
  assign io_mtvec = mtvec;	// <stdin>:3323:10, CSR.scala:21:26
  assign io_mepc = mepc;	// <stdin>:3323:10, CSR.scala:22:26
  assign io_mcause = mcause;	// <stdin>:3323:10, CSR.scala:23:26
endmodule
...
module RAMU(	// <stdin>:3427:10
  ...
  sim_sram data_ram (	// RAM.scala:87:26
    ...
    .arburst (2'h1),	// <stdin>:3427:10
    .arlock  (2'h0),	// <stdin>:3427:10
    .arcache (4'h0),	// <stdin>:3427:10
    .arprot  (3'h0),	// <stdin>:3427:10
    .arvalid (axi_readAddr_valid),
    .rready  (axi_readData_ready),
    .awid    (axi_writeAddr_bits_id),
    .awaddr  (axi_writeAddr_bits_addr),
    .awlen   (8'h0),	// <stdin>:3427:10
    .awsize  (3'h0),	// <stdin>:3427:10
    .awburst (2'h0),	// <stdin>:3427:10
    .awlock  (2'h0),	// <stdin>:3427:10
    .awcache (4'h0),	// <stdin>:3427:10
    .awprot  (3'h0),	// <stdin>:3427:10
    .awvalid (axi_writeAddr_valid),
    .wid     ({3'h0, axi_writeData_bits_id}),	// <stdin>:3427:10, RAM.scala:124:45
    .wdata   (axi_writeData_bits_data),
    .wstrb   (axi_writeData_bits_strb),
    .wlast   (1'h1),	// <stdin>:3427:10
...
module AXI_Arbiter(	// <stdin>:3514:10
  ...
  assign in_0_readData_bits_data = req_0_valid ? out_readData_bits_data : 64'h77;	// <stdin>:3514:10, RAM.scala:66:37, :75:27, :76:17
  assign in_1_readAddr_ready = out_readAddr_ready;	// <stdin>:3514:10
  assign in_1_readData_bits_data = out_readData_bits_data;	// <stdin>:3514:10
  assign in_1_readData_bits_last = out_readData_bits_last;	// <stdin>:3514:10
  assign req_0_ready = req_0_valid;	// <stdin>:3514:10
  assign req_1_ready = ~req_0_valid;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_writeAddr_valid = req_0_valid & in_0_writeAddr_valid;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_writeAddr_bits_addr = req_0_valid ? in_0_writeAddr_bits_addr : 32'h0;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_writeAddr_bits_id = _GEN;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_writeData_valid = req_0_valid & in_0_writeData_valid;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_writeData_bits_data = req_0_valid ? in_0_writeData_bits_data : 64'h0;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_writeData_bits_id = req_0_valid;	// <stdin>:3514:10
  assign out_writeData_bits_strb = req_0_valid ? in_0_writeData_bits_strb : 8'h0;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_writeResp_ready = req_0_valid & in_0_writeResp_ready;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_readAddr_valid = req_0_valid ? in_0_readAddr_valid : in_1_readAddr_valid;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_readAddr_bits_addr = req_0_valid ? in_0_readAddr_bits_addr : in_1_readAddr_bits_addr;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_readAddr_bits_size = req_0_valid ? 3'h6 : 3'h3;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_readAddr_bits_len = {6'h0, ~req_0_valid, 1'h0};	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_readAddr_bits_id = _GEN;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
  assign out_readData_ready = req_0_valid ? in_0_readData_ready : in_1_readData_ready;	// <stdin>:3514:10, RAM.scala:75:27, :76:17
endmodule

module top(	// <stdin>:3554:10
  input          clock,
                 reset,
...
sim simulate (	// top.scala:24:26
  ...
  assign io_ID_npc = _inst_decode_unit_io_ID_to_BPU_bus_bits_br_target;	// <stdin>:3554:10, top.scala:96:34
  assign io_PF_pc = _inst_fetch_unit_io_PF_pc;	// <stdin>:3554:10, top.scala:95:33
  assign io_PF_axidata = _arb_in_1_readData_bits_data;	// <stdin>:3554:10, top.scala:215:21
  assign io_IF_pc = _inst_fetch_unit_io_IF_to_ID_bus_bits_PC;	// <stdin>:3554:10, top.scala:95:33
  assign io_ID_pc = _inst_decode_unit_io_ID_to_EX_bus_bits_PC;	// <stdin>:3554:10, top.scala:96:34
  assign io_EX_pc = _excute_unit_io_EX_to_MEM_bus_bits_PC;	// <stdin>:3554:10, top.scala:97:29
  assign io_PMEM_pc = _pre_mem_unit_io_PMEM_to_MEM_bus_bits_PC;	// <stdin>:3554:10, top.scala:98:30
  assign io_WB_Inst = _wb_unit_io_WB_Inst;	// <stdin>:3554:10, top.scala:100:25
  assign io_WB_RegWriteData = _wb_unit_io_WB_to_ID_forward_bits_regWriteData;	// <stdin>:3554:10, top.scala:100:25
  assign io_WB_RegWriteID = {59'h0, _wb_unit_io_WB_to_ID_forward_bits_regWriteID};	// <stdin>:3554:10, top.scala:100:25, :153:24
  assign io_WB_valid = _wb_unit_io_WB_to_ID_forward_valid;	// <stdin>:3554:10, top.scala:100:25
  assign io_MEM_RegWriteData = _arb_in_0_readData_bits_data;	// <stdin>:3554:10, top.scala:215:21
  assign io_bp_npc = _bp_unit_io_bp_npc;	// <stdin>:3554:10, top.scala:94:33
  assign io_bp_taken = _bp_unit_io_bp_taken;	// <stdin>:3554:10, top.scala:94:33
  assign io_bp_flush = _bp_unit_io_bp_flush;	// <stdin>:3554:10, top.scala:94:33
  assign io_csrWriteEn = _mem_unit_io_MEM_to_WB_bus_bits_csrWriteEn;	// <stdin>:3554:10, top.scala:99:26
  assign io_csrWriteAddr = _mem_unit_io_MEM_to_WB_bus_bits_csrWriteAddr;	// <stdin>:3554:10, top.scala:99:26
  assign io_csrWriteData = _mem_unit_io_MEM_to_WB_bus_bits_csrWriteData;	// <stdin>:3554:10, top.scala:99:26
  assign io_EX_csrWriteData = _excute_unit_io_EX_to_MEM_bus_bits_csrWriteData;	// <stdin>:3554:10, top.scala:97:29
  assign io_cache_axi_req = _inst_fetch_unit_axi_readAddr_valid;	// <stdin>:3554:10, top.scala:95:33
  assign io_cache_rlast = _arb_in_1_readData_bits_last;	// <stdin>:3554:10, top.scala:215:21
  assign io_IF_Inst = _inst_fetch_unit_io_IF_to_ID_bus_bits_Inst;	// <stdin>:3554:10, top.scala:95:33
  assign io_IF_valid = _inst_fetch_unit_io_IF_to_ID_bus_valid;	// <stdin>:3554:10, top.scala:95:33
  assign io_IF_AXIREQ = _arb_req_1_ready;	// <stdin>:3554:10, top.scala:215:21
  assign io_ID_ALU_Data1 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data1;	// <stdin>:3554:10, top.scala:96:34
  assign io_ID_ALU_Data2 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data2;	// <stdin>:3554:10, top.scala:96:34
  assign io_EX_ALU_result_pass = _excute_unit_io_EX_ALUResult_Pass;	// <stdin>:3554:10, top.scala:97:29
  assign io_ID_Rs2Data = _inst_decode_unit_io_ID_to_EX_bus_bits_rs2_data;	// <stdin>:3554:10, top.scala:96:34
  assign io_ALUResult = _excute_unit_io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:3554:10, top.scala:97:29
endmodule
