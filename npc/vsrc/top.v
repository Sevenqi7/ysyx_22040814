...
module IDU(	// <stdin>:16:10
  ...
  wire [2:0]        InstInfo_2 = _InstInfo_T_1 ? 3'h0 : _InstInfo_T_3 ? 3'h1 : _InstInfo_T_5 ? 3'h2 : _InstInfo_T_7 |
                _InstInfo_T_26 ? 3'h5 : 3'h0;	// IDU.scala:103:39, Lookup.scala:31:38, :34:39
  wire [51:0]       _immI_T_2 = {52{io_IF_Inst[31]}};	// Bitwise.scala:77:12, IDU.scala:44:36
  reg  [63:0]       GPR_0;	// IDU.scala:53:22
  reg  [63:0]       GPR_1;	// IDU.scala:53:22
  reg  [63:0]       GPR_2;	// IDU.scala:53:22
  reg  [63:0]       GPR_3;	// IDU.scala:53:22
  reg  [63:0]       GPR_4;	// IDU.scala:53:22
  reg  [63:0]       GPR_5;	// IDU.scala:53:22
  reg  [63:0]       GPR_6;	// IDU.scala:53:22
  reg  [63:0]       GPR_7;	// IDU.scala:53:22
  reg  [63:0]       GPR_8;	// IDU.scala:53:22
  reg  [63:0]       GPR_9;	// IDU.scala:53:22
  reg  [63:0]       GPR_10;	// IDU.scala:53:22
  reg  [63:0]       GPR_11;	// IDU.scala:53:22
  reg  [63:0]       GPR_12;	// IDU.scala:53:22
  reg  [63:0]       GPR_13;	// IDU.scala:53:22
  reg  [63:0]       GPR_14;	// IDU.scala:53:22
  reg  [63:0]       GPR_15;	// IDU.scala:53:22
  reg  [63:0]       GPR_16;	// IDU.scala:53:22
  reg  [63:0]       GPR_17;	// IDU.scala:53:22
  reg  [63:0]       GPR_18;	// IDU.scala:53:22
  reg  [63:0]       GPR_19;	// IDU.scala:53:22
  reg  [63:0]       GPR_20;	// IDU.scala:53:22
  reg  [63:0]       GPR_21;	// IDU.scala:53:22
  reg  [63:0]       GPR_22;	// IDU.scala:53:22
  reg  [63:0]       GPR_23;	// IDU.scala:53:22
  reg  [63:0]       GPR_24;	// IDU.scala:53:22
  reg  [63:0]       GPR_25;	// IDU.scala:53:22
  reg  [63:0]       GPR_26;	// IDU.scala:53:22
  reg  [63:0]       GPR_27;	// IDU.scala:53:22
  reg  [63:0]       GPR_28;	// IDU.scala:53:22
  reg  [63:0]       GPR_29;	// IDU.scala:53:22
  reg  [63:0]       GPR_30;	// IDU.scala:53:22
  reg  [63:0]       GPR_31;	// IDU.scala:53:22
  wire [31:0][63:0] _GEN_1 = {{GPR_31}, {GPR_30}, {GPR_29}, {GPR_28}, {GPR_27}, {GPR_26}, {GPR_25}, {GPR_24}, {GPR_23},
                ...
                {GPR_4}, {GPR_3}, {GPR_2}, {GPR_1}, {GPR_0}};	// IDU.scala:53:22, :64:20
  wire [63:0]       _GEN_2;	// IDU.scala:64:20
  /* synopsys infer_mux_override */
  assign _GEN_2 = _GEN_1[io_IF_Inst[19:15]] /* cadence map_to_mux */;	// IDU.scala:62:22, :64:20
  wire [63:0]       _rs1_data_T_1 = io_IF_Inst[19:15] == 5'h0 ? 64'h0 : _GEN_2;	// IDU.scala:46:63, :53:30, :62:22, :64:{20,25}
  wire              _io_ID_npc_T_8 = _GEN_0 == 2'h0;	// IDU.scala:31:21, :82:19, Lookup.scala:34:39
  wire              _io_ID_RegWriteEn_T_3 = _GEN_0 == 2'h1;	// IDU.scala:84:19, Lookup.scala:34:39
  wire              _io_ID_npc_T_9 = InstInfo_2 == 3'h5;	// IDU.scala:92:15, Lookup.scala:34:39
  wire [63:0]       _io_ID_ALU_Data1_T_5 = io_IF_pc + 64'h4;	// IDU.scala:92:33
  wire              _io_ID_npc_T = _GEN_0 == 2'h2;	// IDU.scala:103:114, Lookup.scala:34:39
  always @(posedge clock) begin
    if (reset) begin
      GPR_0 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_1 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_2 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_3 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_4 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_5 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_6 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_7 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_8 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_9 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_10 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_11 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_12 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_13 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_14 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_15 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_16 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_17 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_18 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_19 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_20 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_21 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_22 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_23 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_24 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_25 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_26 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_27 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_28 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_29 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_30 <= 64'h0;	// IDU.scala:53:{22,30}
      GPR_31 <= 64'h0;	// IDU.scala:53:{22,30}
    end
    else begin
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h0)	// IDU.scala:46:63, :53:22, :68:5, :69:31
        GPR_0 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h1)	// IDU.scala:53:22, :68:5, :69:31
        GPR_1 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h2)	// IDU.scala:53:22, :68:5, :69:31
        GPR_2 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h3)	// IDU.scala:53:22, :68:5, :69:31
        GPR_3 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h4)	// IDU.scala:53:22, :68:5, :69:31
        GPR_4 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h5)	// IDU.scala:53:22, :68:5, :69:31
        GPR_5 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h6)	// IDU.scala:53:22, :68:5, :69:31
        GPR_6 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h7)	// IDU.scala:53:22, :68:5, :69:31
        GPR_7 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h8)	// IDU.scala:53:22, :68:5, :69:31
        GPR_8 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h9)	// IDU.scala:53:22, :68:5, :69:31
        GPR_9 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'hA)	// IDU.scala:53:22, :68:5, :69:31
        GPR_10 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'hB)	// IDU.scala:53:22, :68:5, :69:31
        GPR_11 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'hC)	// IDU.scala:53:22, :68:5, :69:31
        GPR_12 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'hD)	// IDU.scala:53:22, :68:5, :69:31
        GPR_13 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'hE)	// IDU.scala:53:22, :68:5, :69:31
        GPR_14 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'hF)	// IDU.scala:53:22, :68:5, :69:31
        GPR_15 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h10)	// IDU.scala:53:22, :68:5, :69:31
        GPR_16 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h11)	// IDU.scala:53:22, :68:5, :69:31
        GPR_17 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h12)	// IDU.scala:53:22, :68:5, :69:31
        GPR_18 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h13)	// IDU.scala:53:22, :68:5, :69:31, Lookup.scala:31:38
        GPR_19 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h14)	// IDU.scala:53:22, :68:5, :69:31
        GPR_20 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h15)	// IDU.scala:53:22, :68:5, :69:31
        GPR_21 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h16)	// IDU.scala:53:22, :68:5, :69:31
        GPR_22 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h17)	// IDU.scala:53:22, :68:5, :69:31, Lookup.scala:31:38
        GPR_23 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h18)	// IDU.scala:53:22, :68:5, :69:31
        GPR_24 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h19)	// IDU.scala:53:22, :68:5, :69:31
        GPR_25 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h1A)	// IDU.scala:53:22, :68:5, :69:31
        GPR_26 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h1B)	// IDU.scala:53:22, :68:5, :69:31
        GPR_27 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h1C)	// IDU.scala:53:22, :68:5, :69:31
        GPR_28 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h1D)	// IDU.scala:53:22, :68:5, :69:31
        GPR_29 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & io_EX_RegWriteID == 5'h1E)	// IDU.scala:53:22, :68:5, :69:31
        GPR_30 <= io_EX_RegWriteData;	// IDU.scala:53:22
      if (io_EX_RegWriteEn & (&io_EX_RegWriteID))	// IDU.scala:53:22, :68:5, :69:31
        GPR_31 <= io_EX_RegWriteData;	// IDU.scala:53:22
    end
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:16:10
    ...
    initial begin	// <stdin>:16:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:16:10
        ...
        GPR_0 = {_RANDOM_0, _RANDOM_1};	// IDU.scala:53:22
        GPR_1 = {_RANDOM_2, _RANDOM_3};	// IDU.scala:53:22
        GPR_2 = {_RANDOM_4, _RANDOM_5};	// IDU.scala:53:22
        GPR_3 = {_RANDOM_6, _RANDOM_7};	// IDU.scala:53:22
        GPR_4 = {_RANDOM_8, _RANDOM_9};	// IDU.scala:53:22
        GPR_5 = {_RANDOM_10, _RANDOM_11};	// IDU.scala:53:22
        GPR_6 = {_RANDOM_12, _RANDOM_13};	// IDU.scala:53:22
        GPR_7 = {_RANDOM_14, _RANDOM_15};	// IDU.scala:53:22
        GPR_8 = {_RANDOM_16, _RANDOM_17};	// IDU.scala:53:22
        GPR_9 = {_RANDOM_18, _RANDOM_19};	// IDU.scala:53:22
        GPR_10 = {_RANDOM_20, _RANDOM_21};	// IDU.scala:53:22
        GPR_11 = {_RANDOM_22, _RANDOM_23};	// IDU.scala:53:22
        GPR_12 = {_RANDOM_24, _RANDOM_25};	// IDU.scala:53:22
        GPR_13 = {_RANDOM_26, _RANDOM_27};	// IDU.scala:53:22
        GPR_14 = {_RANDOM_28, _RANDOM_29};	// IDU.scala:53:22
        GPR_15 = {_RANDOM_30, _RANDOM_31};	// IDU.scala:53:22
        GPR_16 = {_RANDOM_32, _RANDOM_33};	// IDU.scala:53:22
        GPR_17 = {_RANDOM_34, _RANDOM_35};	// IDU.scala:53:22
        GPR_18 = {_RANDOM_36, _RANDOM_37};	// IDU.scala:53:22
        GPR_19 = {_RANDOM_38, _RANDOM_39};	// IDU.scala:53:22
        GPR_20 = {_RANDOM_40, _RANDOM_41};	// IDU.scala:53:22
        GPR_21 = {_RANDOM_42, _RANDOM_43};	// IDU.scala:53:22
        GPR_22 = {_RANDOM_44, _RANDOM_45};	// IDU.scala:53:22
        GPR_23 = {_RANDOM_46, _RANDOM_47};	// IDU.scala:53:22
        GPR_24 = {_RANDOM_48, _RANDOM_49};	// IDU.scala:53:22
        GPR_25 = {_RANDOM_50, _RANDOM_51};	// IDU.scala:53:22
        GPR_26 = {_RANDOM_52, _RANDOM_53};	// IDU.scala:53:22
        GPR_27 = {_RANDOM_54, _RANDOM_55};	// IDU.scala:53:22
        GPR_28 = {_RANDOM_56, _RANDOM_57};	// IDU.scala:53:22
        GPR_29 = {_RANDOM_58, _RANDOM_59};	// IDU.scala:53:22
        GPR_30 = {_RANDOM_60, _RANDOM_61};	// IDU.scala:53:22
        GPR_31 = {_RANDOM_62, _RANDOM_63};	// IDU.scala:53:22
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_ID_npc = _io_ID_npc_T ? io_IF_pc + {{44{io_IF_Inst[31]}}, io_IF_Inst[19:12], io_IF_Inst[20],
                ...
                io_IF_Inst[31:20]} : {32'h0, _io_ID_ALU_Data1_T_5[31:0]};	// <stdin>:16:10, Bitwise.scala:77:12, IDU.scala:34:21, :44:{36,53}, :48:{54,76,101}, :64:20, :82:19, :92:{15,33}, :103:114, :107:13, :109:40, :111:{31,58}, Mux.scala:101:16
  assign io_ID_ALU_Data1 = InstInfo_2 == 3'h0 ? 64'h0 : InstInfo_2 == 3'h1 ? io_IF_pc : InstInfo_2 == 3'h2 ?
                _rs1_data_T_1 : _io_ID_npc_T_9 ? _io_ID_ALU_Data1_T_5 : 64'h0;	// <stdin>:16:10, IDU.scala:53:30, :64:20, :89:15, :90:15, :91:15, :92:{15,33}, :103:39, Lookup.scala:34:39, Mux.scala:101:16
  assign io_ID_ALU_Data2 = ~_InstInfo_T_1 & (_InstInfo_T_3 | _InstInfo_T_5) ? (_io_ID_npc_T_8 ? {_immI_T_2,
                ...
                12'h0} : 64'h0) : 64'h0;	// <stdin>:16:10, Bitwise.scala:77:12, Cat.scala:33:92, IDU.scala:44:{36,53}, :45:{10,53,63}, :53:30, :82:19, :84:19, Lookup.scala:31:38, :34:39, Mux.scala:101:16
  ...
  assign io_ID_RegWriteEn = _io_ID_npc_T_8 | _io_ID_RegWriteEn_T_3 | _io_ID_npc_T;	// <stdin>:16:10, IDU.scala:82:19, :84:19, :103:{101,114}
endmodule

module EXU(	// <stdin>:241:10
  ...
  assign io_EX_RegWriteData = io_ID_optype == 4'h1 ? io_ID_ALU_Data1 + io_ID_ALU_Data2 : io_ID_optype == 4'h2 ?
                io_ID_ALU_Data1 - io_ID_ALU_Data2 : 64'h0;	// <stdin>:241:10, EXU.scala:25:{23,52}, :26:{23,52}, Mux.scala:101:16
  assign io_EX_RegWriteID = io_ID_RegWriteID;	// <stdin>:241:10
  assign io_EX_RegWriteEn = io_ID_RegWriteEn;	// <stdin>:241:10
endmodule

module top(	// <stdin>:260:10
  input         clock,
                reset,
  input  [31:0] io_inst,
  output [63:0] io_IF_pc,
  ...
  assign io_IF_pc = _inst_fetch_unit_io_IF_pc;	// <stdin>:260:10, top.scala:22:33
  assign io_ALUResult = _excute_unit_io_EX_RegWriteData;	// <stdin>:260:10, top.scala:24:29
endmodule
