...
module RAMU(	// <stdin>:3434:10
  ...
  sim_sram data_ram (	// RAM.scala:89:26
    ...
    .wid     ({3'h0, axi_writeData_bits_id}),	// <stdin>:3434:10, RAM.scala:128:45
...
module AXI_Arbiter(	// <stdin>:3525:10
  ...
  assign in_0_readData_bits_data = req_0_valid ? out_readData_bits_data : 64'h77;	// <stdin>:3525:10, RAM.scala:67:37, :76:27, :77:17
  ...
  assign req_1_ready = ~req_0_valid;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_writeAddr_valid = req_0_valid & in_0_writeAddr_valid;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_writeAddr_bits_addr = req_0_valid ? in_0_writeAddr_bits_addr : 32'h0;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_writeAddr_bits_id = _GEN;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_writeData_valid = req_0_valid & in_0_writeData_valid;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_writeData_bits_data = req_0_valid ? in_0_writeData_bits_data : 64'h0;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_writeData_bits_id = req_0_valid;	// <stdin>:3525:10
  assign out_writeData_bits_strb = req_0_valid ? in_0_writeData_bits_strb : 8'h0;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_writeResp_ready = req_0_valid & in_0_writeResp_ready;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_readAddr_valid = req_0_valid ? in_0_readAddr_valid : in_1_readAddr_valid;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_readAddr_bits_addr = req_0_valid ? in_0_readAddr_bits_addr : in_1_readAddr_bits_addr;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_readAddr_bits_size = req_0_valid ? 3'h6 : 3'h3;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_readAddr_bits_len = {6'h0, ~req_0_valid, 1'h0};	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_readAddr_bits_id = _GEN;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
  assign out_readData_ready = req_0_valid ? in_0_readData_ready : in_1_readData_ready;	// <stdin>:3525:10, RAM.scala:76:27, :77:17
endmodule
