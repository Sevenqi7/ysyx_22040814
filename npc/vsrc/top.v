...
module IF_pre_fetch(	// <stdin>:25:10
  ...
  reg  [63:0] PF_npc;	// pre_fetch.scala:19:27
  ...
  always @(posedge clock) begin
    if (reset) begin
      PF_npc <= 64'h80000000;	// pre_fetch.scala:19:27
      ...
      if (io_stall) begin
        ...
        PF_npc <= io_ID_npc;	// pre_fetch.scala:19:27
      else	// pre_fetch.scala:29:82
        PF_npc <= PF_npc + 64'h4;	// pre_fetch.scala:19:27, :24:37
    ...
    if (reset | _io_bp_fail_T_6)	// pre_fetch.scala:29:82, :32:64
      ...
      rhsReg <= PF_npc;	// pre_fetch.scala:19:27, tools.scala:32:33
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:25:10
    ...
    initial begin	// <stdin>:25:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:25:10
        ...
        PF_npc = {_RANDOM_0, _RANDOM_1};	// pre_fetch.scala:19:27
  ...
  assign io_inst_valid = axi_lite_readData_valid & axi_lite_readData_bits_resp == 2'h0 & ~_io_bp_fail_T_6 &
                ~bp_fail_r;	// <stdin>:25:10, pre_fetch.scala:29:82, :30:28, :47:{96,107,119,121}
  assign io_PF_pc = rhsReg;	// <stdin>:25:10, tools.scala:32:33
  assign io_bp_fail = _io_bp_fail_T_6;	// <stdin>:25:10, pre_fetch.scala:29:82
  assign io_PF_npc = PF_npc;	// <stdin>:25:10, pre_fetch.scala:19:27
  assign axi_lite_readAddr_valid = ~io_stall;	// <stdin>:25:10, pre_fetch.scala:29:85
  assign axi_lite_readAddr_bits_addr = PF_npc[31:0];	// <stdin>:25:10, pre_fetch.scala:19:27, :44:46
...
module IDU(	// <stdin>:166:10
  ...
  `ifndef SYNTHESIS	// <stdin>:166:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_IF_to_ID_bus_ready = ~_load_use_stall_T_18;	// <stdin>:166:10, IDU.scala:201:82, :212:170
  ...
  assign io_ID_stall = _load_use_stall_T_18;	// <stdin>:166:10, IDU.scala:212:170
