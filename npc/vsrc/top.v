...
module BPU(	// <stdin>:165:10
  ...
  assign io_bp_taken = _GEN;	// <stdin>:165:10, bpu.scala:172:18, :173:21, :174:18
  ...
  assign io_bp_npc = _io_bp_flush_T_2 ? io_ID_to_BPU_bus_bits_br_target : _GEN ? _BTB_io_readData : io_PF_pc +
                64'h4;	// <stdin>:165:10, Mux.scala:101:16, bpu.scala:141:21, :159:63, :160:43, :172:18, :173:21, :174:18
...
module IF_pre_fetch(	// <stdin>:777:10
  input         clock,
                reset,
                io_stall,
  ...
  `ifndef SYNTHESIS	// <stdin>:777:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:777:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:777:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:777:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:777:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:777:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:777:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:777:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:777:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:777:10
        `INIT_RANDOM_PROLOG_	// <stdin>:777:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:777:10
        _RANDOM_0 = `RANDOM;	// <stdin>:777:10
        _RANDOM_1 = `RANDOM;	// <stdin>:777:10
        _RANDOM_2 = `RANDOM;	// <stdin>:777:10
        _RANDOM_3 = `RANDOM;	// <stdin>:777:10
        _RANDOM_4 = `RANDOM;	// <stdin>:777:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:777:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:777:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_inst_valid = axi_lite_readData_valid & axi_lite_readData_bits_resp == 2'h0 & ~axi_busy & ~bp_fail_r;	// <stdin>:777:10, pre_fetch.scala:26:27, :29:28, :65:{96,107,117,119}
  assign io_PF_pc = rhsReg;	// <stdin>:777:10, tools.scala:32:33
  assign io_PF_npc = PF_npc;	// <stdin>:777:10, pre_fetch.scala:24:27
  assign axi_lite_readAddr_valid = ~io_stall;	// <stdin>:777:10, pre_fetch.scala:60:40
  assign axi_lite_readAddr_bits_addr = io_bp_taken ? io_bp_npc[31:0] : PF_npc[31:0];	// <stdin>:777:10, pre_fetch.scala:24:27, :61:{43,74}
  assign axi_lite_readData_ready = ~io_stall;	// <stdin>:777:10, pre_fetch.scala:60:40
endmodule
...
module IFU(	// <stdin>:842:10
  ...
  assign io_PF_pc = _pre_fetch_io_PF_pc;	// <stdin>:842:10, IFU.scala:59:27
  assign io_PF_valid = _pre_fetch_io_inst_valid;	// <stdin>:842:10, IFU.scala:59:27
...
module AXI_Arbiter(	// <stdin>:2282:10
  ...
  assign in_0_readData_bits_data = req_0_valid ? out_readData_bits_data : 64'h77;	// <stdin>:2282:10, top.scala:168:37, :174:27, :175:17
  ...
  assign req_1_ready = ~req_0_valid;	// <stdin>:2282:10, top.scala:174:27, :178:30
  assign out_writeAddr_valid = req_0_valid & in_0_writeAddr_valid;	// <stdin>:2282:10, top.scala:174:27, :175:17
  assign out_writeAddr_bits_addr = req_0_valid ? in_0_writeAddr_bits_addr : 32'h0;	// <stdin>:2282:10, top.scala:174:27, :175:17
  assign out_writeData_valid = req_0_valid & in_0_writeData_valid;	// <stdin>:2282:10, top.scala:174:27, :175:17
  assign out_writeData_bits_data = req_0_valid ? in_0_writeData_bits_data : 64'h0;	// <stdin>:2282:10, top.scala:174:27, :175:17
  assign out_writeData_bits_strb = req_0_valid ? in_0_writeData_bits_strb : 8'h0;	// <stdin>:2282:10, top.scala:174:27, :175:17
  assign out_writeResp_ready = req_0_valid & in_0_writeResp_ready;	// <stdin>:2282:10, top.scala:174:27, :175:17
  assign out_readAddr_valid = req_0_valid ? in_0_readAddr_valid : in_1_readAddr_valid;	// <stdin>:2282:10, top.scala:174:27, :175:17
  assign out_readAddr_bits_addr = req_0_valid ? in_0_readAddr_bits_addr : in_1_readAddr_bits_addr;	// <stdin>:2282:10, top.scala:174:27, :175:17
  assign out_readData_ready = req_0_valid ? in_0_readData_ready : in_1_readData_ready;	// <stdin>:2282:10, top.scala:174:27, :175:17
endmodule
...
sim simulate (	// top.scala:24:26
  ...
  assign io_ID_npc = _inst_decode_unit_io_ID_to_BPU_bus_bits_br_target;	// <stdin>:2316:10, top.scala:63:34
  assign io_PF_pc = _inst_fetch_unit_io_PF_pc;	// <stdin>:2316:10, top.scala:62:33
  assign io_IF_pc = _inst_fetch_unit_io_IF_to_ID_bus_bits_PC;	// <stdin>:2316:10, top.scala:62:33
  assign io_ID_pc = _inst_decode_unit_io_ID_to_EX_bus_bits_PC;	// <stdin>:2316:10, top.scala:63:34
  assign io_EX_pc = _excute_unit_io_EX_to_MEM_bus_bits_PC;	// <stdin>:2316:10, top.scala:64:29
  assign io_PMEM_pc = _pre_mem_unit_io_PMEM_to_MEM_bus_bits_PC;	// <stdin>:2316:10, top.scala:65:30
  assign io_WB_Inst = _wb_unit_io_WB_Inst;	// <stdin>:2316:10, top.scala:67:25
  assign io_WB_RegWriteData = _wb_unit_io_WB_to_ID_forward_bits_regWriteData;	// <stdin>:2316:10, top.scala:67:25
  assign io_WB_RegWriteID = {59'h0, _wb_unit_io_WB_to_ID_forward_bits_regWriteID};	// <stdin>:2316:10, top.scala:67:25, :96:24
  assign io_MEM_RegWriteData = _arb_in_0_readData_bits_data;	// <stdin>:2316:10, top.scala:147:21
  assign io_bp_npc = _bp_unit_io_bp_npc;	// <stdin>:2316:10, top.scala:61:33
  assign io_bp_taken = _bp_unit_io_bp_taken;	// <stdin>:2316:10, top.scala:61:33
  assign io_bp_flush = _bp_unit_io_bp_flush;	// <stdin>:2316:10, top.scala:61:33
  assign io_IF_Inst = _inst_fetch_unit_io_IF_to_ID_bus_bits_Inst;	// <stdin>:2316:10, top.scala:62:33
  assign io_IF_valid = _inst_fetch_unit_io_IF_to_ID_bus_valid;	// <stdin>:2316:10, top.scala:62:33
  assign io_IF_AXIREQ = _arb_req_1_ready;	// <stdin>:2316:10, top.scala:147:21
  assign io_ID_ALU_Data1 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data1;	// <stdin>:2316:10, top.scala:63:34
  assign io_ID_ALU_Data2 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data2;	// <stdin>:2316:10, top.scala:63:34
  assign io_ID_Rs2Data = _inst_decode_unit_io_ID_to_EX_bus_bits_rs2_data;	// <stdin>:2316:10, top.scala:63:34
  assign io_ALUResult = _excute_unit_io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:2316:10, top.scala:64:29
endmodule
