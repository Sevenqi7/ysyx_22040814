...
module BPU(	// <stdin>:291:10
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      _BHT_T_3 = {_GEN_36[2:0], 1'h0} + {3'h0, io_ID_to_BPU_bus_bits_taken};	// bpu.scala:148:30, :206:41, :214:52
