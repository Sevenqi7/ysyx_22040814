...
module IDU(	// <stdin>:12:10
  ...
  wire              _InstInfo_T_9 = _GEN == 10'h67;	// Lookup.scala:31:38
  wire              _InstInfo_T_11 = _GEN == 10'h313;	// Lookup.scala:31:38
  wire              _InstInfo_T_40 = _GEN == 10'h1A3;	// Lookup.scala:31:38
  wire [16:0]       _GEN_0 = {io_IF_Inst[31:25], io_IF_Inst[14:12], io_IF_Inst[6:0]};	// Lookup.scala:31:38
  wire              _InstInfo_T_15 = _GEN_0 == 17'h33;	// Lookup.scala:31:38
  wire              _InstInfo_T_17 = _GEN_0 == 17'hB3;	// Lookup.scala:31:38
  wire              _InstInfo_T_19 = _GEN_0 == 17'h8033;	// Lookup.scala:31:38
  wire              _InstInfo_T_21 = _GEN_0 == 17'h333;	// Lookup.scala:31:38
  wire              _InstInfo_T_68 = io_IF_Inst[6:0] == 7'h6F;	// Lookup.scala:31:38
  wire [2:0]        InstInfo_0 = _InstInfo_T_1 ? 3'h7 : _InstInfo_T_3 | _InstInfo_T_5 ? 3'h3 : _InstInfo_T_7 | _InstInfo_T_9
                | _InstInfo_T_11 ? 3'h1 : _InstInfo_T_40 ? 3'h4 : _InstInfo_T_15 | _InstInfo_T_17 |
                _InstInfo_T_19 | _InstInfo_T_21 ? 3'h2 : _InstInfo_T_68 ? 3'h5 : 3'h0;	// Lookup.scala:31:38, :34:39
  wire [2:0]        InstInfo_2 = _InstInfo_T_1 ? 3'h0 : _InstInfo_T_3 ? 3'h1 : _InstInfo_T_5 ? 3'h0 : _InstInfo_T_7 ? 3'h2 :
                _InstInfo_T_9 ? 3'h6 : _InstInfo_T_11 | _InstInfo_T_40 | _InstInfo_T_15 | _InstInfo_T_17 |
                _InstInfo_T_19 | _InstInfo_T_21 ? 3'h2 : _InstInfo_T_68 ? 3'h6 : 3'h0;	// Lookup.scala:31:38, :34:39
  wire [2:0]        InstInfo_3 = _InstInfo_T_1 ? 3'h0 : _InstInfo_T_3 | _InstInfo_T_5 | _InstInfo_T_7 ? 3'h4 : _InstInfo_T_9
                ? 3'h0 : _InstInfo_T_11 | _InstInfo_T_40 ? 3'h4 : _InstInfo_T_15 ? 3'h3 : _InstInfo_T_17 ?
                3'h5 : {1'h0, _InstInfo_T_19 ? 2'h3 : {2{_InstInfo_T_21}}};	// Lookup.scala:31:38, :34:39
  wire [51:0]       _immI_T_2 = {52{io_IF_Inst[31]}};	// Bitwise.scala:77:12, IDU.scala:52:36
  wire [51:0]       _GEN_1 = {52{io_IF_Inst[31]}};	// IDU.scala:52:36, :54:10
  reg  [63:0]       GPR_0;	// IDU.scala:61:22
  reg  [63:0]       GPR_1;	// IDU.scala:61:22
  reg  [63:0]       GPR_2;	// IDU.scala:61:22
  reg  [63:0]       GPR_3;	// IDU.scala:61:22
  reg  [63:0]       GPR_4;	// IDU.scala:61:22
  reg  [63:0]       GPR_5;	// IDU.scala:61:22
  reg  [63:0]       GPR_6;	// IDU.scala:61:22
  reg  [63:0]       GPR_7;	// IDU.scala:61:22
  reg  [63:0]       GPR_8;	// IDU.scala:61:22
  reg  [63:0]       GPR_9;	// IDU.scala:61:22
  reg  [63:0]       GPR_10;	// IDU.scala:61:22
  reg  [63:0]       GPR_11;	// IDU.scala:61:22
  reg  [63:0]       GPR_12;	// IDU.scala:61:22
  reg  [63:0]       GPR_13;	// IDU.scala:61:22
  reg  [63:0]       GPR_14;	// IDU.scala:61:22
  reg  [63:0]       GPR_15;	// IDU.scala:61:22
  reg  [63:0]       GPR_16;	// IDU.scala:61:22
  reg  [63:0]       GPR_17;	// IDU.scala:61:22
  reg  [63:0]       GPR_18;	// IDU.scala:61:22
  reg  [63:0]       GPR_19;	// IDU.scala:61:22
  reg  [63:0]       GPR_20;	// IDU.scala:61:22
  reg  [63:0]       GPR_21;	// IDU.scala:61:22
  reg  [63:0]       GPR_22;	// IDU.scala:61:22
  reg  [63:0]       GPR_23;	// IDU.scala:61:22
  reg  [63:0]       GPR_24;	// IDU.scala:61:22
  reg  [63:0]       GPR_25;	// IDU.scala:61:22
  reg  [63:0]       GPR_26;	// IDU.scala:61:22
  reg  [63:0]       GPR_27;	// IDU.scala:61:22
  reg  [63:0]       GPR_28;	// IDU.scala:61:22
  reg  [63:0]       GPR_29;	// IDU.scala:61:22
  reg  [63:0]       GPR_30;	// IDU.scala:61:22
  reg  [63:0]       GPR_31;	// IDU.scala:61:22
  wire [31:0][63:0] _GEN_2 = {{GPR_31}, {GPR_30}, {GPR_29}, {GPR_28}, {GPR_27}, {GPR_26}, {GPR_25}, {GPR_24}, {GPR_23},
                {GPR_22}, {GPR_21}, {GPR_20}, {GPR_19}, {GPR_18}, {GPR_17}, {GPR_16}, {GPR_15}, {GPR_14},
                {GPR_13}, {GPR_12}, {GPR_11}, {GPR_10}, {GPR_9}, {GPR_8}, {GPR_7}, {GPR_6}, {GPR_5},
                {GPR_4}, {GPR_3}, {GPR_2}, {GPR_1}, {GPR_0}};	// IDU.scala:61:22, :72:20
  wire [63:0]       _GEN_3;	// IDU.scala:72:20
  /* synopsys infer_mux_override */
  assign _GEN_3 = _GEN_2[io_IF_Inst[19:15]] /* cadence map_to_mux */;	// IDU.scala:70:22, :72:20
  wire [63:0]       _rs1_data_T_1 = io_IF_Inst[19:15] == 5'h0 ? 64'h0 : _GEN_3;	// IDU.scala:54:63, :61:30, :70:22, :72:{20,25}
  wire [63:0]       _GEN_4;	// IDU.scala:73:20
  /* synopsys infer_mux_override */
  assign _GEN_4 = _GEN_2[io_IF_Inst[24:20]] /* cadence map_to_mux */;	// IDU.scala:71:22, :72:20, :73:20
  wire              _io_ID_npc_T_8 = InstInfo_0 == 3'h1;	// IDU.scala:95:19, Lookup.scala:34:39
  wire              _io_ID_npc_T_4 = InstInfo_0 == 3'h6;	// IDU.scala:96:19, Lookup.scala:34:39
  wire              _io_ID_RegWriteEn_T_3 = InstInfo_0 == 3'h3;	// IDU.scala:97:19, Lookup.scala:34:39
  wire              _io_ID_MemWriteEn_T = InstInfo_0 == 3'h4;	// IDU.scala:98:19, Lookup.scala:34:39
  wire              _io_ID_npc_T_9 = InstInfo_2 == 3'h6;	// IDU.scala:105:15, Lookup.scala:34:39
  wire [63:0]       _io_ID_ALU_Data1_T_5 = io_IF_pc + 64'h4;	// IDU.scala:105:33
  wire              _io_ID_npc_T = InstInfo_0 == 3'h5;	// IDU.scala:117:114, Lookup.scala:34:39
  always @(posedge clock) begin
    if (reset) begin
      GPR_0 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_1 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_2 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_3 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_4 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_5 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_6 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_7 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_8 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_9 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_10 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_11 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_12 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_13 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_14 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_15 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_16 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_17 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_18 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_19 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_20 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_21 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_22 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_23 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_24 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_25 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_26 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_27 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_28 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_29 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_30 <= 64'h0;	// IDU.scala:61:{22,30}
      GPR_31 <= 64'h0;	// IDU.scala:61:{22,30}
    end
    else begin
      automatic logic _T_2 = io_EX_RegWriteEn & (|io_EX_RegWriteID);	// IDU.scala:78:{36,56}
      if (_T_2 & io_EX_RegWriteID == 5'h0)	// IDU.scala:54:63, :61:22, :78:36, :79:5, :80:31
        GPR_0 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h1)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_1 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h2)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_2 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h3)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_3 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h4)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_4 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h5)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_5 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h6)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_6 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h7)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_7 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h8)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_8 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h9)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_9 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'hA)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_10 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'hB)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_11 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'hC)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_12 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'hD)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_13 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'hE)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_14 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'hF)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_15 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h10)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_16 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h11)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_17 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h12)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_18 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h13)	// IDU.scala:61:22, :78:36, :79:5, :80:31, Lookup.scala:31:38
        GPR_19 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h14)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_20 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h15)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_21 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h16)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_22 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h17)	// IDU.scala:61:22, :78:36, :79:5, :80:31, Lookup.scala:31:38
        GPR_23 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h18)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_24 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h19)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_25 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h1A)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_26 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h1B)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_27 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h1C)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_28 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h1D)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_29 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & io_EX_RegWriteID == 5'h1E)	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_30 <= io_EX_RegWriteData;	// IDU.scala:61:22
      if (_T_2 & (&io_EX_RegWriteID))	// IDU.scala:61:22, :78:36, :79:5, :80:31
        GPR_31 <= io_EX_RegWriteData;	// IDU.scala:61:22
    end
  end // always @(posedge)
  `ifndef SYNTHESIS	// <stdin>:12:10
    ...
    initial begin	// <stdin>:12:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:12:10
        ...
        GPR_0 = {_RANDOM_0, _RANDOM_1};	// IDU.scala:61:22
        GPR_1 = {_RANDOM_2, _RANDOM_3};	// IDU.scala:61:22
        GPR_2 = {_RANDOM_4, _RANDOM_5};	// IDU.scala:61:22
        GPR_3 = {_RANDOM_6, _RANDOM_7};	// IDU.scala:61:22
        GPR_4 = {_RANDOM_8, _RANDOM_9};	// IDU.scala:61:22
        GPR_5 = {_RANDOM_10, _RANDOM_11};	// IDU.scala:61:22
        GPR_6 = {_RANDOM_12, _RANDOM_13};	// IDU.scala:61:22
        GPR_7 = {_RANDOM_14, _RANDOM_15};	// IDU.scala:61:22
        GPR_8 = {_RANDOM_16, _RANDOM_17};	// IDU.scala:61:22
        GPR_9 = {_RANDOM_18, _RANDOM_19};	// IDU.scala:61:22
        GPR_10 = {_RANDOM_20, _RANDOM_21};	// IDU.scala:61:22
        GPR_11 = {_RANDOM_22, _RANDOM_23};	// IDU.scala:61:22
        GPR_12 = {_RANDOM_24, _RANDOM_25};	// IDU.scala:61:22
        GPR_13 = {_RANDOM_26, _RANDOM_27};	// IDU.scala:61:22
        GPR_14 = {_RANDOM_28, _RANDOM_29};	// IDU.scala:61:22
        GPR_15 = {_RANDOM_30, _RANDOM_31};	// IDU.scala:61:22
        GPR_16 = {_RANDOM_32, _RANDOM_33};	// IDU.scala:61:22
        GPR_17 = {_RANDOM_34, _RANDOM_35};	// IDU.scala:61:22
        GPR_18 = {_RANDOM_36, _RANDOM_37};	// IDU.scala:61:22
        GPR_19 = {_RANDOM_38, _RANDOM_39};	// IDU.scala:61:22
        GPR_20 = {_RANDOM_40, _RANDOM_41};	// IDU.scala:61:22
        GPR_21 = {_RANDOM_42, _RANDOM_43};	// IDU.scala:61:22
        GPR_22 = {_RANDOM_44, _RANDOM_45};	// IDU.scala:61:22
        GPR_23 = {_RANDOM_46, _RANDOM_47};	// IDU.scala:61:22
        GPR_24 = {_RANDOM_48, _RANDOM_49};	// IDU.scala:61:22
        GPR_25 = {_RANDOM_50, _RANDOM_51};	// IDU.scala:61:22
        GPR_26 = {_RANDOM_52, _RANDOM_53};	// IDU.scala:61:22
        GPR_27 = {_RANDOM_54, _RANDOM_55};	// IDU.scala:61:22
        GPR_28 = {_RANDOM_56, _RANDOM_57};	// IDU.scala:61:22
        GPR_29 = {_RANDOM_58, _RANDOM_59};	// IDU.scala:61:22
        GPR_30 = {_RANDOM_60, _RANDOM_61};	// IDU.scala:61:22
        GPR_31 = {_RANDOM_62, _RANDOM_63};	// IDU.scala:61:22
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_ID_npc = _io_ID_npc_T ? io_IF_pc + {{44{io_IF_Inst[31]}}, io_IF_Inst[19:12], io_IF_Inst[20],
                io_IF_Inst[30:21], 1'h0} : _io_ID_npc_T_4 ? io_IF_pc + {_GEN_1, io_IF_Inst[7],
                io_IF_Inst[30:25], io_IF_Inst[11:8], 1'h0} : _io_ID_npc_T_8 & _io_ID_npc_T_9 ?
                _rs1_data_T_1 + {_immI_T_2, io_IF_Inst[31:20]} : {32'h0, _io_ID_ALU_Data1_T_5[31:0]};	// <stdin>:12:10, Bitwise.scala:77:12, IDU.scala:52:{36,53}, :54:10, :55:{80,107,128}, :56:{54,76,101}, :72:20, :95:19, :96:19, :105:{15,33}, :117:114, :122:13, :124:40, :125:40, :126:{31,58}, Lookup.scala:34:39, Mux.scala:101:16
  assign io_ID_ALU_Data1 = InstInfo_2 == 3'h0 ? 64'h0 : InstInfo_2 == 3'h1 ? io_IF_pc : InstInfo_2 == 3'h2 ?
                _rs1_data_T_1 : _io_ID_npc_T_9 ? _io_ID_ALU_Data1_T_5 : 64'h0;	// <stdin>:12:10, IDU.scala:61:30, :72:20, :102:15, :103:15, :104:15, :105:{15,33}, Lookup.scala:34:39, Mux.scala:101:16
  assign io_ID_ALU_Data2 = InstInfo_3 == 3'h0 ? 64'h0 : InstInfo_3 == 3'h1 ? io_IF_pc : InstInfo_3 == 3'h3 ?
                _rs1_data_T_1 : InstInfo_3 == 3'h4 ? (_io_ID_npc_T_8 ? {_immI_T_2, io_IF_Inst[31:20]} :
                ...
                _io_ID_MemWriteEn_T ? {_GEN_1, io_IF_Inst[31:25], io_IF_Inst[11:7]} : 64'h0) : {58'h0,
                InstInfo_3 == 3'h5 ? io_IF_Inst[25:20] : 6'h0};	// <stdin>:12:10, Bitwise.scala:77:12, Cat.scala:33:92, IDU.scala:52:{36,53}, :53:{10,53,63}, :54:{10,53,80}, :55:{80,107,128}, :57:24, :61:30, :72:20, :95:19, :96:19, :97:19, :98:19, :109:15, :110:15, :111:15, :112:15, :113:15, Lookup.scala:34:39, Mux.scala:101:16
  assign io_ID_FuType = ~_InstInfo_T_1 & ~_InstInfo_T_3 & ~_InstInfo_T_5 & ~_InstInfo_T_7 & ~_InstInfo_T_9 &
                ~_InstInfo_T_11 & _InstInfo_T_40;	// <stdin>:12:10, Lookup.scala:31:38, :34:39
  assign io_ID_optype = _InstInfo_T_1 | _InstInfo_T_3 | _InstInfo_T_5 | _InstInfo_T_7 | _InstInfo_T_9 ? 4'h1 :
                _InstInfo_T_11 ? 4'h5 : _InstInfo_T_40 ? 4'h8 : {1'h0, _InstInfo_T_15 ? 3'h1 :
                _InstInfo_T_17 ? 3'h7 : _InstInfo_T_19 ? 3'h2 : _InstInfo_T_21 ? 3'h5 : {2'h0,
                _InstInfo_T_68}};	// <stdin>:12:10, Lookup.scala:31:38, :34:39
  assign io_ID_Rs2Data = io_IF_Inst[24:20] == 5'h0 ? 64'h0 : _GEN_4;	// <stdin>:12:10, IDU.scala:54:63, :61:30, :71:22, :73:{20,25}
  assign io_ID_RegWriteID = io_IF_Inst[11:7];	// <stdin>:12:10, IDU.scala:54:80
  assign io_ID_RegWriteEn = InstInfo_0 == 3'h2 | _io_ID_npc_T_8 | _io_ID_RegWriteEn_T_3 | _io_ID_npc_T;	// <stdin>:12:10, IDU.scala:95:19, :97:19, :117:{39,101,114}, Lookup.scala:34:39
  assign io_ID_MemWriteEn = _io_ID_MemWriteEn_T;	// <stdin>:12:10, IDU.scala:98:19
  assign io_ID_GPR_0 = GPR_0;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_1 = GPR_1;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_2 = GPR_2;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_3 = GPR_3;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_4 = GPR_4;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_5 = GPR_5;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_6 = GPR_6;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_7 = GPR_7;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_8 = GPR_8;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_9 = GPR_9;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_10 = GPR_10;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_11 = GPR_11;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_12 = GPR_12;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_13 = GPR_13;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_14 = GPR_14;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_15 = GPR_15;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_16 = GPR_16;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_17 = GPR_17;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_18 = GPR_18;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_19 = GPR_19;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_20 = GPR_20;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_21 = GPR_21;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_22 = GPR_22;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_23 = GPR_23;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_24 = GPR_24;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_25 = GPR_25;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_26 = GPR_26;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_27 = GPR_27;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_28 = GPR_28;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_29 = GPR_29;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_30 = GPR_30;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_GPR_31 = GPR_31;	// <stdin>:12:10, IDU.scala:61:22
  assign io_ID_unknown_inst = InstInfo_0 == 3'h0;	// <stdin>:12:10, IDU.scala:41:39, Lookup.scala:34:39
endmodule

module EXU(	// <stdin>:298:10
  ...
  wire [126:0] _ALU_Result_T_15 = {63'h0, io_ID_ALU_Data1} << io_ID_ALU_Data2[5:0];	// EXU.scala:33:29, :42:52
  assign io_EX_ALUResult = io_ID_optype == 4'h1 | io_ID_FuType ? io_ID_ALU_Data1 + io_ID_ALU_Data2 : io_ID_optype ==
                4'h2 ? io_ID_ALU_Data1 - io_ID_ALU_Data2 : io_ID_optype == 4'h4 ? io_ID_ALU_Data1 &
                io_ID_ALU_Data2 : io_ID_optype == 4'h5 ? io_ID_ALU_Data1 | io_ID_ALU_Data2 : io_ID_optype
                == 4'h6 ? io_ID_ALU_Data1 ^ io_ID_ALU_Data2 : io_ID_optype == 4'h7 ? _ALU_Result_T_15[63:0]
                : 64'h0;	// <stdin>:298:10, EXU.scala:37:{23,35,83}, :38:{23,53}, :39:{23,53}, :40:{23,53}, :41:{23,53}, :42:{23,52}, Mux.scala:101:16
  assign io_EX_MemWriteData = io_ID_Rs2Data;	// <stdin>:298:10
  assign io_EX_MemWriteEn = io_ID_MemWriteEn;	// <stdin>:298:10
  assign io_EX_LsuType = io_ID_FuType ? io_ID_optype : 4'h0;	// <stdin>:298:10, EXU.scala:31:28
  assign io_EX_RegWriteID = io_ID_RegWriteID;	// <stdin>:298:10
  assign io_EX_RegWriteEn = io_ID_RegWriteEn;	// <stdin>:298:10
endmodule

// external module LSU

module MEMU(	// <stdin>:347:10
  ...
  assign io_MEM_RegWriteData = (|io_EX_LsuType) & ~io_EX_MemWriteEn ? _mem_ReadData : io_EX_ALUResult;	// <stdin>:347:10, MEMU.scala:34:21, :39:{31,47,56,77}
  assign io_MEM_RegWriteEn = io_EX_RegWriteEn;	// <stdin>:347:10
  assign io_MEM_RegWriteID = io_EX_RegWriteID;	// <stdin>:347:10
endmodule

// external module sim

module top(	// <stdin>:379:10
  input         clock,
                reset,
  output [63:0] io_IF_pc,
                io_ALUResult);
  ...
  wire [3:0]  _inst_decode_unit_io_ID_optype;	// top.scala:24:34
...
sim simulate (	// top.scala:24:26
  ...
  assign io_IF_pc = _inst_fetch_unit_io_IF_pc;	// <stdin>:379:10, top.scala:23:33
  assign io_ALUResult = _mem_unit_io_MEM_RegWriteData;	// <stdin>:379:10, top.scala:26:26
endmodule
