...
module IDU(	// <stdin>:166:10
  ...
  `ifndef SYNTHESIS	// <stdin>:166:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_IF_to_ID_bus_ready = ~_io_ID_stall_T_21;	// <stdin>:166:10, IDU.scala:190:82, :197:21
  assign io_ID_npc = _io_ID_npc_T ? io_IF_to_ID_bus_bits_PC + {{44{io_IF_to_ID_bus_bits_Inst[31]}},
                ...
                _ALU_Data1_T_5[31:0]};	// <stdin>:166:10, Bitwise.scala:77:12, IDU.scala:84:{33,47}, :86:10, :87:{71,95,113}, :88:{48,67,89}, :131:31, :149:19, :150:19, :159:{15,30}, :170:104, :202:13, :203:19, :204:{34,46}, :205:{34,46}, :206:{34,53}, :207:{34,53}, :208:{34,46}, :209:{34,46}, :213:13, :215:37, :216:{31,55}, :217:{31,58}, Lookup.scala:34:39, Mux.scala:101:16
  ...
  assign io_ID_stall = _io_ID_stall_T_21;	// <stdin>:166:10, IDU.scala:197:21
  assign io_ID_GPR_0 = GPR_0;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_1 = GPR_1;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_2 = GPR_2;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_3 = GPR_3;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_4 = GPR_4;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_5 = GPR_5;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_6 = GPR_6;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_7 = GPR_7;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_8 = GPR_8;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_9 = GPR_9;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_10 = GPR_10;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_11 = GPR_11;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_12 = GPR_12;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_13 = GPR_13;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_14 = GPR_14;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_15 = GPR_15;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_16 = GPR_16;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_17 = GPR_17;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_18 = GPR_18;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_19 = GPR_19;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_20 = GPR_20;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_21 = GPR_21;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_22 = GPR_22;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_23 = GPR_23;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_24 = GPR_24;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_25 = GPR_25;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_26 = GPR_26;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_27 = GPR_27;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_28 = GPR_28;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_29 = GPR_29;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_30 = GPR_30;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_GPR_31 = GPR_31;	// <stdin>:166:10, IDU.scala:99:22
  assign io_ID_unknown_inst = InstInfo_0 == 3'h0 & io_IF_to_ID_bus_valid;	// <stdin>:166:10, IDU.scala:195:{39,47}, Lookup.scala:34:39
endmodule

module EXU(	// <stdin>:934:10
  input         clock,
                reset,
  ...
  `ifndef SYNTHESIS	// <stdin>:934:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:934:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:934:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:934:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:934:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:934:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:934:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:934:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:934:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:934:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:934:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:934:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:934:10
        `INIT_RANDOM_PROLOG_	// <stdin>:934:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:934:10
        _RANDOM_0 = `RANDOM;	// <stdin>:934:10
        _RANDOM_1 = `RANDOM;	// <stdin>:934:10
        _RANDOM_2 = `RANDOM;	// <stdin>:934:10
        _RANDOM_3 = `RANDOM;	// <stdin>:934:10
        _RANDOM_4 = `RANDOM;	// <stdin>:934:10
        _RANDOM_5 = `RANDOM;	// <stdin>:934:10
        _RANDOM_6 = `RANDOM;	// <stdin>:934:10
        _RANDOM_7 = `RANDOM;	// <stdin>:934:10
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:934:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:934:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_EX_to_MEM_bus_valid = rhsReg_9;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_Inst = rhsReg_1;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_PC = rhsReg;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_ALU_result = rhsReg_7;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_memWriteData = rhsReg_6;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_memWriteEn = rhsReg_4;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_memReadEn = rhsReg_5;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_lsutype = rhsReg_8;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_regWriteID = rhsReg_3;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_regWriteEn = rhsReg_2;	// <stdin>:934:10, tools.scala:15:29
  assign io_EX_ALUResult_Pass = _GEN_5;	// <stdin>:934:10, Mux.scala:101:16
endmodule
...
module MEMU(	// <stdin>:1238:10
  ...
  assign io_MEM_to_WB_bus_valid = rhsReg_5;	// <stdin>:1238:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteData = rhsReg_4;	// <stdin>:1238:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteEn = rhsReg_2;	// <stdin>:1238:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteID = rhsReg_3;	// <stdin>:1238:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_PC = rhsReg;	// <stdin>:1238:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_Inst = rhsReg_1;	// <stdin>:1238:10, tools.scala:15:29
  assign io_MEM_regWriteData_Pass = io_EX_to_MEM_bus_bits_memReadEn ? _mem_ReadData : io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:1238:10, MEMU.scala:50:21, :54:24
endmodule

module WBU(	// <stdin>:1288:10
  ...
  assign io_WB_RegWriteData = io_MEM_to_WB_bus_bits_regWriteData;	// <stdin>:1288:10
  assign io_WB_RegWriteEn = io_MEM_to_WB_bus_bits_regWriteEn;	// <stdin>:1288:10
  assign io_WB_RegWriteID = io_MEM_to_WB_bus_bits_regWriteID;	// <stdin>:1288:10
  assign io_WB_valid = io_MEM_to_WB_bus_valid;	// <stdin>:1288:10
  assign io_WB_pc = io_MEM_to_WB_bus_bits_PC;	// <stdin>:1288:10
  assign io_WB_Inst = io_MEM_to_WB_bus_bits_Inst;	// <stdin>:1288:10
endmodule
...
sim simulate (	// top.scala:24:26
  ...
  assign io_ID_npc = _inst_decode_unit_io_ID_npc;	// <stdin>:1311:10, top.scala:46:34
  assign io_IF_pc = _inst_fetch_unit_io_IF_to_ID_bus_bits_PC;	// <stdin>:1311:10, top.scala:45:33
  assign io_ID_pc = _inst_decode_unit_io_ID_to_EX_bus_bits_PC;	// <stdin>:1311:10, top.scala:46:34
  assign io_EX_pc = _excute_unit_io_EX_to_MEM_bus_bits_PC;	// <stdin>:1311:10, top.scala:47:29
  assign io_WB_Inst = _wb_unit_io_WB_Inst;	// <stdin>:1311:10, top.scala:49:25
  assign io_WB_RegWriteData = _wb_unit_io_WB_RegWriteData;	// <stdin>:1311:10, top.scala:49:25
  assign io_WB_RegWriteID = {59'h0, _wb_unit_io_WB_RegWriteID};	// <stdin>:1311:10, top.scala:49:25, :63:24
  assign io_MEM_RegWriteData = _mem_unit_io_MEM_regWriteData_Pass;	// <stdin>:1311:10, top.scala:48:26
  assign io_IF_Inst = _inst_fetch_unit_io_IF_to_ID_bus_bits_Inst;	// <stdin>:1311:10, top.scala:45:33
  assign io_IF_valid = _inst_fetch_unit_io_IF_to_ID_bus_valid;	// <stdin>:1311:10, top.scala:45:33
  assign io_ID_ALU_Data1 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data1;	// <stdin>:1311:10, top.scala:46:34
  assign io_ID_ALU_Data2 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data2;	// <stdin>:1311:10, top.scala:46:34
  assign io_ID_Rs2Data = _inst_decode_unit_io_ID_to_EX_bus_bits_rs2_data;	// <stdin>:1311:10, top.scala:46:34
  assign io_ALUResult = _excute_unit_io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:1311:10, top.scala:47:29
endmodule
