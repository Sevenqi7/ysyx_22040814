...
module BPU(	// <stdin>:165:10
  ...
  wire              _T_11 = io_PF_inst[6:0] == 7'h63 | io_PF_inst[6:0] == 7'h6F | io_PF_inst[6:0] == 7'h67;	// bpu.scala:132:28, :136:24, :137:{24,53}, :143:18
  ...
  wire              _T_10 = _BTB_io_hit & io_PF_valid;	// bpu.scala:150:21, :182:21
  ...
  assign _GEN = _T_10 & _T_11 & _GEN_3[0];	// bpu.scala:143:18, :181:18, :182:{21,55}, :183:{18,34}
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_11 & ~io_ID_to_BPU_bus_bits_load_use_stall) begin	// bpu.scala:143:{18,28,30}
      ...
      if (io_PF_valid & _T_11 & ~io_ID_to_BPU_bus_bits_load_use_stall)	// bpu.scala:143:{18,30}, :209:42
        br_cnt <= br_cnt + 32'h1;	// bpu.scala:205:26, :210:26
      if (_io_bp_flush_T_1)	// bpu.scala:168:49
        bp_fail <= bp_fail + 32'h1;	// bpu.scala:206:26, :210:26, :213:28
      if (_T_10 & _T_11 & ~io_ID_to_BPU_bus_bits_load_use_stall)	// bpu.scala:143:{18,30}, :182:21, :215:55
  ...
  assign io_hit_cnt = hit_cnt;	// <stdin>:165:10, bpu.scala:207:26
endmodule

module IF_pre_fetch(	// <stdin>:817:10
  input         clock,
                reset,
                io_stall,
  ...
  `ifndef SYNTHESIS	// <stdin>:817:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:817:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:817:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:817:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:817:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:817:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:817:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:817:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:817:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:817:10
        `INIT_RANDOM_PROLOG_	// <stdin>:817:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:817:10
        _RANDOM_0 = `RANDOM;	// <stdin>:817:10
        _RANDOM_1 = `RANDOM;	// <stdin>:817:10
        _RANDOM_2 = `RANDOM;	// <stdin>:817:10
        _RANDOM_3 = `RANDOM;	// <stdin>:817:10
        _RANDOM_4 = `RANDOM;	// <stdin>:817:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_inst_valid = axi_lite_readData_valid & axi_lite_readData_bits_resp == 2'h0 & axi_req_ready & ~axi_busy;	// <stdin>:817:10, pre_fetch.scala:26:27, :81:{96,121,123}
  assign io_PF_pc = rhsReg;	// <stdin>:817:10, tools.scala:15:29
  assign io_PF_npc = PF_npc;	// <stdin>:817:10, pre_fetch.scala:24:27
  assign axi_lite_readAddr_valid = ~io_stall;	// <stdin>:817:10, pre_fetch.scala:70:40
  assign axi_lite_readAddr_bits_addr = io_bp_flush ? io_bp_npc[31:0] : io_stall | ~axi_req_ready | axi_busy ? rhsReg[31:0] :
                io_bp_taken ? io_bp_npc[31:0] : PF_npc[31:0];	// <stdin>:817:10, Mux.scala:101:16, pre_fetch.scala:24:27, :26:27, :27:17, :71:88, :74:72, tools.scala:15:29
  assign axi_lite_readData_ready = ~io_stall;	// <stdin>:817:10, pre_fetch.scala:70:40
endmodule

module IFU(	// <stdin>:900:10
  input         clock,
                reset,
  ...
  always @(posedge clock) begin
    if (reset | io_bp_flush) begin	// IFU.scala:77:61
      ...
      rhsReg_1 <= 1'h0;	// <stdin>:900:10, tools.scala:32:33
  ...
  assign io_IF_to_ID_bus_valid = rhsReg_1;	// <stdin>:900:10, tools.scala:32:33
  assign io_IF_to_ID_bus_bits_PC = rhsReg;	// <stdin>:900:10, tools.scala:32:33
  assign io_IF_to_ID_bus_bits_Inst = rhsReg_2[31:0];	// <stdin>:900:10, tools.scala:32:33, :37:17
  assign io_PF_pc = _pre_fetch_io_PF_pc;	// <stdin>:900:10, IFU.scala:59:27
  assign io_PF_valid = _pre_fetch_io_inst_valid;	// <stdin>:900:10, IFU.scala:59:27
  assign io_axidata = axi_lite_readData_bits_data;	// <stdin>:900:10
endmodule

module IDU(	// <stdin>:961:10
  input         clock,
                reset,
  ...
  `ifndef SYNTHESIS	// <stdin>:961:10
    ...
    initial begin	// <stdin>:961:10
      ...
      automatic logic [31:0] _RANDOM_5;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_8;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_9;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_10;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_11;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_12;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_13;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_14;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_15;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_16;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_17;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_18;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_19;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_20;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_21;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_22;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_23;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_24;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_25;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_26;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_27;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_28;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_29;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_30;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_31;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_32;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_33;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_34;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_35;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_36;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_37;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_38;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_39;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_40;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_41;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_42;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_43;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_44;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_45;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_46;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_47;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_48;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_49;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_50;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_51;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_52;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_53;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_54;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_55;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_56;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_57;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_58;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_59;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_60;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_61;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_62;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_63;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_64;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_65;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_66;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_67;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_68;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_69;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_70;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_71;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_72;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_73;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_74;	// <stdin>:961:10
      automatic logic [31:0] _RANDOM_75;	// <stdin>:961:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:961:10
        ...
        _RANDOM_5 = `RANDOM;	// <stdin>:961:10
        _RANDOM_6 = `RANDOM;	// <stdin>:961:10
        _RANDOM_7 = `RANDOM;	// <stdin>:961:10
        _RANDOM_8 = `RANDOM;	// <stdin>:961:10
        _RANDOM_9 = `RANDOM;	// <stdin>:961:10
        _RANDOM_10 = `RANDOM;	// <stdin>:961:10
        _RANDOM_11 = `RANDOM;	// <stdin>:961:10
        _RANDOM_12 = `RANDOM;	// <stdin>:961:10
        _RANDOM_13 = `RANDOM;	// <stdin>:961:10
        _RANDOM_14 = `RANDOM;	// <stdin>:961:10
        _RANDOM_15 = `RANDOM;	// <stdin>:961:10
        _RANDOM_16 = `RANDOM;	// <stdin>:961:10
        _RANDOM_17 = `RANDOM;	// <stdin>:961:10
        _RANDOM_18 = `RANDOM;	// <stdin>:961:10
        _RANDOM_19 = `RANDOM;	// <stdin>:961:10
        _RANDOM_20 = `RANDOM;	// <stdin>:961:10
        _RANDOM_21 = `RANDOM;	// <stdin>:961:10
        _RANDOM_22 = `RANDOM;	// <stdin>:961:10
        _RANDOM_23 = `RANDOM;	// <stdin>:961:10
        _RANDOM_24 = `RANDOM;	// <stdin>:961:10
        _RANDOM_25 = `RANDOM;	// <stdin>:961:10
        _RANDOM_26 = `RANDOM;	// <stdin>:961:10
        _RANDOM_27 = `RANDOM;	// <stdin>:961:10
        _RANDOM_28 = `RANDOM;	// <stdin>:961:10
        _RANDOM_29 = `RANDOM;	// <stdin>:961:10
        _RANDOM_30 = `RANDOM;	// <stdin>:961:10
        _RANDOM_31 = `RANDOM;	// <stdin>:961:10
        _RANDOM_32 = `RANDOM;	// <stdin>:961:10
        _RANDOM_33 = `RANDOM;	// <stdin>:961:10
        _RANDOM_34 = `RANDOM;	// <stdin>:961:10
        _RANDOM_35 = `RANDOM;	// <stdin>:961:10
        _RANDOM_36 = `RANDOM;	// <stdin>:961:10
        _RANDOM_37 = `RANDOM;	// <stdin>:961:10
        _RANDOM_38 = `RANDOM;	// <stdin>:961:10
        _RANDOM_39 = `RANDOM;	// <stdin>:961:10
        _RANDOM_40 = `RANDOM;	// <stdin>:961:10
        _RANDOM_41 = `RANDOM;	// <stdin>:961:10
        _RANDOM_42 = `RANDOM;	// <stdin>:961:10
        _RANDOM_43 = `RANDOM;	// <stdin>:961:10
        _RANDOM_44 = `RANDOM;	// <stdin>:961:10
        _RANDOM_45 = `RANDOM;	// <stdin>:961:10
        _RANDOM_46 = `RANDOM;	// <stdin>:961:10
        _RANDOM_47 = `RANDOM;	// <stdin>:961:10
        _RANDOM_48 = `RANDOM;	// <stdin>:961:10
        _RANDOM_49 = `RANDOM;	// <stdin>:961:10
        _RANDOM_50 = `RANDOM;	// <stdin>:961:10
        _RANDOM_51 = `RANDOM;	// <stdin>:961:10
        _RANDOM_52 = `RANDOM;	// <stdin>:961:10
        _RANDOM_53 = `RANDOM;	// <stdin>:961:10
        _RANDOM_54 = `RANDOM;	// <stdin>:961:10
        _RANDOM_55 = `RANDOM;	// <stdin>:961:10
        _RANDOM_56 = `RANDOM;	// <stdin>:961:10
        _RANDOM_57 = `RANDOM;	// <stdin>:961:10
        _RANDOM_58 = `RANDOM;	// <stdin>:961:10
        _RANDOM_59 = `RANDOM;	// <stdin>:961:10
        _RANDOM_60 = `RANDOM;	// <stdin>:961:10
        _RANDOM_61 = `RANDOM;	// <stdin>:961:10
        _RANDOM_62 = `RANDOM;	// <stdin>:961:10
        _RANDOM_63 = `RANDOM;	// <stdin>:961:10
        _RANDOM_64 = `RANDOM;	// <stdin>:961:10
        _RANDOM_65 = `RANDOM;	// <stdin>:961:10
        _RANDOM_66 = `RANDOM;	// <stdin>:961:10
        _RANDOM_67 = `RANDOM;	// <stdin>:961:10
        _RANDOM_68 = `RANDOM;	// <stdin>:961:10
        _RANDOM_69 = `RANDOM;	// <stdin>:961:10
        _RANDOM_70 = `RANDOM;	// <stdin>:961:10
        _RANDOM_71 = `RANDOM;	// <stdin>:961:10
        _RANDOM_72 = `RANDOM;	// <stdin>:961:10
        _RANDOM_73 = `RANDOM;	// <stdin>:961:10
        _RANDOM_74 = `RANDOM;	// <stdin>:961:10
        _RANDOM_75 = `RANDOM;	// <stdin>:961:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_IF_to_ID_bus_ready = ~_load_use_stall_T_22;	// <stdin>:961:10, IDU.scala:209:81, :223:65
  assign io_ID_to_EX_bus_valid = rhsReg_14;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_ALU_Data1 = rhsReg_2;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_ALU_Data2 = rhsReg_3;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_futype = rhsReg_9[0];	// <stdin>:961:10, tools.scala:23:33, :25:17
  assign io_ID_to_EX_bus_bits_optype = rhsReg_8;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_rs1_data = rhsReg_10;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_rs2_data = rhsReg_12;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_regWriteID = rhsReg_4;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_regWriteEn = rhsReg_5;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_memWriteEn = rhsReg_7;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_memReadEn = rhsReg_6;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_PC = rhsReg;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_EX_bus_bits_Inst = rhsReg_1;	// <stdin>:961:10, tools.scala:23:33
  assign io_ID_to_BPU_bus_valid = io_IF_to_ID_bus_valid & (_io_ID_to_BPU_bus_valid_T | _io_ID_to_BPU_bus_valid_T_1 |
                _io_ID_to_BPU_bus_valid_T_3 & _io_ID_to_BPU_bus_valid_T_4) & ~_load_use_stall_T_22;	// <stdin>:961:10, IDU.scala:166:19, :167:19, :176:15, :187:104, :209:81, :223:65, :260:{108,133,152}
  assign io_ID_to_BPU_bus_bits_PC = io_IF_to_ID_bus_bits_PC;	// <stdin>:961:10
  assign io_ID_to_BPU_bus_bits_taken = _io_ID_to_BPU_bus_valid_T | (_io_ID_to_BPU_bus_valid_T_1 ? _GEN_10 :
                _io_ID_to_BPU_bus_valid_T_3 & _io_ID_to_BPU_bus_valid_T_4);	// <stdin>:961:10, IDU.scala:166:19, :167:19, :176:15, :187:104, :234:19, :235:34, :244:15, :245:21, :246:31, :247:31, :248:31
  assign io_ID_to_BPU_bus_bits_br_target = _io_ID_to_BPU_bus_valid_T ? io_IF_to_ID_bus_bits_PC + {{44{io_IF_to_ID_bus_bits_Inst[31]}},
                ...
                io_IF_to_ID_bus_bits_Inst[31:20]} : {32'h0, _ALU_Data1_T_5[31:0]};	// <stdin>:961:10, Bitwise.scala:77:12, IDU.scala:104:25, :107:{25,44,66,92}, :108:{48,72,90}, :166:19, :167:19, :176:{15,30}, :187:104, :234:19, :235:34, :252:13, :254:37, :255:{31,50}, :256:{31,58}, Lookup.scala:34:39, Mux.scala:101:16
  assign io_ID_to_BPU_bus_bits_load_use_stall = _load_use_stall_T_22;	// <stdin>:961:10, IDU.scala:223:65
  assign io_ID_stall = _load_use_stall_T_22;	// <stdin>:961:10, IDU.scala:223:65
  assign io_ID_GPR_0 = GPR_0;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_1 = GPR_1;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_2 = GPR_2;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_3 = GPR_3;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_4 = GPR_4;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_5 = GPR_5;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_6 = GPR_6;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_7 = GPR_7;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_8 = GPR_8;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_9 = GPR_9;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_10 = GPR_10;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_11 = GPR_11;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_12 = GPR_12;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_13 = GPR_13;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_14 = GPR_14;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_15 = GPR_15;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_16 = GPR_16;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_17 = GPR_17;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_18 = GPR_18;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_19 = GPR_19;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_20 = GPR_20;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_21 = GPR_21;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_22 = GPR_22;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_23 = GPR_23;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_24 = GPR_24;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_25 = GPR_25;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_26 = GPR_26;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_27 = GPR_27;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_28 = GPR_28;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_29 = GPR_29;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_30 = GPR_30;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_GPR_31 = GPR_31;	// <stdin>:961:10, IDU.scala:114:22
  assign io_ID_unknown_inst = InstInfo_0 == 3'h0 & io_IF_to_ID_bus_valid;	// <stdin>:961:10, IDU.scala:216:{39,47}, Lookup.scala:34:39
endmodule

module EXU(	// <stdin>:1775:10
  input         clock,
                reset,
                io_ID_to_EX_bus_valid,
  ...
  `ifndef SYNTHESIS	// <stdin>:1775:10
    ...
    initial begin	// <stdin>:1775:10
      ...
      automatic logic [31:0] _RANDOM_3;	// <stdin>:1775:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:1775:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:1775:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:1775:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:1775:10
      ...
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:1775:10
        ...
        _RANDOM_3 = `RANDOM;	// <stdin>:1775:10
        _RANDOM_4 = `RANDOM;	// <stdin>:1775:10
        _RANDOM_5 = `RANDOM;	// <stdin>:1775:10
        _RANDOM_6 = `RANDOM;	// <stdin>:1775:10
        _RANDOM_7 = `RANDOM;	// <stdin>:1775:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_EX_to_MEM_bus_valid = rhsReg_9;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_Inst = rhsReg_1;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_PC = rhsReg;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_ALU_result = rhsReg_7;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_memWriteData = rhsReg_6;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_memWriteEn = rhsReg_4;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_memReadEn = rhsReg_5;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_lsutype = rhsReg_8;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_regWriteID = rhsReg_3;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_to_MEM_bus_bits_regWriteEn = rhsReg_2;	// <stdin>:1775:10, tools.scala:15:29
  assign io_EX_ALUResult_Pass = _GEN_5;	// <stdin>:1775:10, Mux.scala:101:16
endmodule

module MEM_pre_stage(	// <stdin>:2042:10
  input         clock,
                reset,
  ...
  `ifndef SYNTHESIS	// <stdin>:2042:10
    `ifdef FIRRTL_BEFORE_INITIAL	// <stdin>:2042:10
      `FIRRTL_BEFORE_INITIAL	// <stdin>:2042:10
    `endif // FIRRTL_BEFORE_INITIAL
    initial begin	// <stdin>:2042:10
      automatic logic [31:0] _RANDOM_0;	// <stdin>:2042:10
      automatic logic [31:0] _RANDOM_1;	// <stdin>:2042:10
      automatic logic [31:0] _RANDOM_2;	// <stdin>:2042:10
      automatic logic [31:0] _RANDOM_3;	// <stdin>:2042:10
      automatic logic [31:0] _RANDOM_4;	// <stdin>:2042:10
      automatic logic [31:0] _RANDOM_5;	// <stdin>:2042:10
      automatic logic [31:0] _RANDOM_6;	// <stdin>:2042:10
      automatic logic [31:0] _RANDOM_7;	// <stdin>:2042:10
      `ifdef INIT_RANDOM_PROLOG_	// <stdin>:2042:10
        `INIT_RANDOM_PROLOG_	// <stdin>:2042:10
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// <stdin>:2042:10
        _RANDOM_0 = `RANDOM;	// <stdin>:2042:10
        _RANDOM_1 = `RANDOM;	// <stdin>:2042:10
        _RANDOM_2 = `RANDOM;	// <stdin>:2042:10
        _RANDOM_3 = `RANDOM;	// <stdin>:2042:10
        _RANDOM_4 = `RANDOM;	// <stdin>:2042:10
        _RANDOM_5 = `RANDOM;	// <stdin>:2042:10
        _RANDOM_6 = `RANDOM;	// <stdin>:2042:10
        _RANDOM_7 = `RANDOM;	// <stdin>:2042:10
        rhsReg = {_RANDOM_0, _RANDOM_1};	// tools.scala:15:29
        rhsReg_1 = _RANDOM_2;	// tools.scala:15:29
    ...
    `ifdef FIRRTL_AFTER_INITIAL	// <stdin>:2042:10
      `FIRRTL_AFTER_INITIAL	// <stdin>:2042:10
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_PMEM_to_MEM_bus_valid = rhsReg_9;	// <stdin>:2042:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_ALU_result = rhsReg_2;	// <stdin>:2042:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_regWriteEn = rhsReg_3;	// <stdin>:2042:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_regWriteID = rhsReg_4;	// <stdin>:2042:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_memReadEn = rhsReg_5;	// <stdin>:2042:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_PC = rhsReg;	// <stdin>:2042:10, tools.scala:15:29
  assign io_PMEM_to_MEM_bus_bits_Inst = rhsReg_1;	// <stdin>:2042:10, tools.scala:15:29
  assign io_PMEM_to_ID_forward_bits_ALU_result = io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:2042:10
  assign io_PMEM_to_ID_forward_bits_regWriteEn = io_EX_to_MEM_bus_bits_regWriteEn;	// <stdin>:2042:10
  assign io_PMEM_to_ID_forward_bits_regWriteID = io_EX_to_MEM_bus_bits_regWriteID;	// <stdin>:2042:10
  assign io_PMEM_to_ID_forward_bits_memReadEn = io_EX_to_MEM_bus_bits_memReadEn;	// <stdin>:2042:10
  assign io_memReadData = rhsReg_8 == 5'h11 ? axi_lite_readData_bits_data : rhsReg_8 == 5'h9 ?
                ...
                axi_lite_readData_bits_data[7:0]} : 64'h0;	// <stdin>:2042:10, Bitwise.scala:77:12, Cat.scala:33:92, PMEM.scala:50:20, :58:17, :59:44, :60:30, :61:{30,65}, :62:{30,65}, :63:{30,65}, :64:{30,60}, :65:{30,60}, :66:{30,60}, tools.scala:9:34, :15:29
  assign axi_lite_writeAddr_valid = io_EX_to_MEM_bus_bits_memWriteEn;	// <stdin>:2042:10
  assign axi_lite_writeAddr_bits_addr = io_EX_to_MEM_bus_bits_ALU_result[31:0];	// <stdin>:2042:10, PMEM.scala:85:58
  assign axi_lite_writeData_valid = io_EX_to_MEM_bus_bits_memWriteEn;	// <stdin>:2042:10
  assign axi_lite_writeData_bits_data = io_EX_to_MEM_bus_bits_memWriteData;	// <stdin>:2042:10
  assign axi_lite_writeData_bits_strb = io_EX_to_MEM_bus_bits_lsutype == 5'h10 ? 8'hFF : io_EX_to_MEM_bus_bits_lsutype == 5'h8 ?
                ...
                == 5'h2};	// <stdin>:2042:10, PMEM.scala:49:11, :50:20, :51:24, :52:24, :53:24, :54:24
  assign axi_lite_writeResp_ready = io_EX_to_MEM_bus_bits_memWriteEn;	// <stdin>:2042:10
  assign axi_lite_readAddr_valid = io_EX_to_MEM_bus_bits_memReadEn;	// <stdin>:2042:10
  assign axi_lite_readAddr_bits_addr = io_EX_to_MEM_bus_bits_ALU_result[31:0];	// <stdin>:2042:10, PMEM.scala:85:58
  assign axi_lite_readData_ready = io_EX_to_MEM_bus_bits_memReadEn;	// <stdin>:2042:10
  assign axi_req_valid = (|io_EX_to_MEM_bus_bits_lsutype) | (|rhsReg_8);	// <stdin>:2042:10, PMEM.scala:47:{34,41,76}, tools.scala:15:29
endmodule

module MEMU(	// <stdin>:2185:10
  input         clock,
                reset,
  ...
  `ifndef SYNTHESIS	// <stdin>:2185:10
    ...
    `endif // FIRRTL_AFTER_INITIAL
  `endif // not def SYNTHESIS
  assign io_MEM_to_WB_bus_valid = rhsReg_5;	// <stdin>:2185:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteData = rhsReg_4;	// <stdin>:2185:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteEn = rhsReg_2;	// <stdin>:2185:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_regWriteID = rhsReg_3;	// <stdin>:2185:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_PC = rhsReg;	// <stdin>:2185:10, tools.scala:15:29
  assign io_MEM_to_WB_bus_bits_Inst = rhsReg_1;	// <stdin>:2185:10, tools.scala:15:29
  assign io_MEM_to_ID_forward_bits_regWriteData = io_PMEM_to_MEM_bus_bits_memReadEn ? io_memReadData : io_PMEM_to_MEM_bus_bits_ALU_result;	// <stdin>:2185:10, MEMU.scala:59:24
  assign io_MEM_to_ID_forward_bits_regWriteEn = io_PMEM_to_MEM_bus_bits_regWriteEn;	// <stdin>:2185:10
  assign io_MEM_to_ID_forward_bits_regWriteID = io_PMEM_to_MEM_bus_bits_regWriteID;	// <stdin>:2185:10
endmodule

module WBU(	// <stdin>:2225:10
  ...
  assign io_WB_to_ID_forward_valid = io_MEM_to_WB_bus_valid;	// <stdin>:2225:10
  assign io_WB_to_ID_forward_bits_regWriteData = io_MEM_to_WB_bus_bits_regWriteData;	// <stdin>:2225:10
  assign io_WB_to_ID_forward_bits_regWriteEn = io_MEM_to_WB_bus_bits_regWriteEn;	// <stdin>:2225:10
  assign io_WB_to_ID_forward_bits_regWriteID = io_MEM_to_WB_bus_bits_regWriteID;	// <stdin>:2225:10
  assign io_WB_pc = io_MEM_to_WB_bus_bits_PC;	// <stdin>:2225:10
  assign io_WB_Inst = io_MEM_to_WB_bus_bits_Inst;	// <stdin>:2225:10
endmodule
...
module AXI_Arbiter(	// <stdin>:2343:10
  ...
  assign in_0_readData_bits_data = req_0_valid ? out_readData_bits_data : 64'h77;	// <stdin>:2343:10, top.scala:174:37, :180:27, :181:17
  assign in_1_readData_valid = out_readData_valid;	// <stdin>:2343:10
  assign in_1_readData_bits_data = out_readData_bits_data;	// <stdin>:2343:10
  assign in_1_readData_bits_resp = out_readData_bits_resp;	// <stdin>:2343:10
  assign req_0_ready = req_0_valid;	// <stdin>:2343:10
  assign req_1_ready = ~req_0_valid;	// <stdin>:2343:10, top.scala:180:27, :184:30
  assign out_writeAddr_valid = req_0_valid & in_0_writeAddr_valid;	// <stdin>:2343:10, top.scala:180:27, :181:17
  assign out_writeAddr_bits_addr = req_0_valid ? in_0_writeAddr_bits_addr : 32'h0;	// <stdin>:2343:10, top.scala:180:27, :181:17
  assign out_writeData_valid = req_0_valid & in_0_writeData_valid;	// <stdin>:2343:10, top.scala:180:27, :181:17
  assign out_writeData_bits_data = req_0_valid ? in_0_writeData_bits_data : 64'h0;	// <stdin>:2343:10, top.scala:180:27, :181:17
  assign out_writeData_bits_strb = req_0_valid ? in_0_writeData_bits_strb : 8'h0;	// <stdin>:2343:10, top.scala:180:27, :181:17
  assign out_writeResp_ready = req_0_valid & in_0_writeResp_ready;	// <stdin>:2343:10, top.scala:180:27, :181:17
  assign out_readAddr_valid = req_0_valid ? in_0_readAddr_valid : in_1_readAddr_valid;	// <stdin>:2343:10, top.scala:180:27, :181:17
  assign out_readAddr_bits_addr = req_0_valid ? in_0_readAddr_bits_addr : in_1_readAddr_bits_addr;	// <stdin>:2343:10, top.scala:180:27, :181:17
  assign out_readData_ready = req_0_valid ? in_0_readData_ready : in_1_readData_ready;	// <stdin>:2343:10, top.scala:180:27, :181:17
endmodule

module top(	// <stdin>:2377:10
  input         clock,
                reset,
...
sim simulate (	// top.scala:24:26
  ...
  assign io_ID_npc = _inst_decode_unit_io_ID_to_BPU_bus_bits_br_target;	// <stdin>:2377:10, top.scala:66:34
  assign io_PF_pc = _inst_fetch_unit_io_PF_pc;	// <stdin>:2377:10, top.scala:65:33
  assign io_PF_axidata = _inst_fetch_unit_io_axidata;	// <stdin>:2377:10, top.scala:65:33
  assign io_IF_pc = _inst_fetch_unit_io_IF_to_ID_bus_bits_PC;	// <stdin>:2377:10, top.scala:65:33
  assign io_ID_pc = _inst_decode_unit_io_ID_to_EX_bus_bits_PC;	// <stdin>:2377:10, top.scala:66:34
  assign io_EX_pc = _excute_unit_io_EX_to_MEM_bus_bits_PC;	// <stdin>:2377:10, top.scala:67:29
  assign io_PMEM_pc = _pre_mem_unit_io_PMEM_to_MEM_bus_bits_PC;	// <stdin>:2377:10, top.scala:68:30
  assign io_WB_Inst = _wb_unit_io_WB_Inst;	// <stdin>:2377:10, top.scala:70:25
  assign io_WB_RegWriteData = _wb_unit_io_WB_to_ID_forward_bits_regWriteData;	// <stdin>:2377:10, top.scala:70:25
  assign io_WB_RegWriteID = {59'h0, _wb_unit_io_WB_to_ID_forward_bits_regWriteID};	// <stdin>:2377:10, top.scala:70:25, :102:24
  assign io_MEM_RegWriteData = _arb_in_0_readData_bits_data;	// <stdin>:2377:10, top.scala:153:21
  assign io_bp_npc = _bp_unit_io_bp_npc;	// <stdin>:2377:10, top.scala:64:33
  assign io_bp_taken = _bp_unit_io_bp_taken;	// <stdin>:2377:10, top.scala:64:33
  assign io_bp_flush = _bp_unit_io_bp_flush;	// <stdin>:2377:10, top.scala:64:33
  assign io_IF_Inst = _inst_fetch_unit_io_IF_to_ID_bus_bits_Inst;	// <stdin>:2377:10, top.scala:65:33
  assign io_IF_valid = _inst_fetch_unit_io_IF_to_ID_bus_valid;	// <stdin>:2377:10, top.scala:65:33
  assign io_IF_AXIREQ = _arb_req_1_ready;	// <stdin>:2377:10, top.scala:153:21
  assign io_ID_ALU_Data1 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data1;	// <stdin>:2377:10, top.scala:66:34
  assign io_ID_ALU_Data2 = _inst_decode_unit_io_ID_to_EX_bus_bits_ALU_Data2;	// <stdin>:2377:10, top.scala:66:34
  assign io_ID_Rs2Data = _inst_decode_unit_io_ID_to_EX_bus_bits_rs2_data;	// <stdin>:2377:10, top.scala:66:34
  assign io_ALUResult = _excute_unit_io_EX_to_MEM_bus_bits_ALU_result;	// <stdin>:2377:10, top.scala:67:29
endmodule
