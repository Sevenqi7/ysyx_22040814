...
class BPU extends Module{
    ...
    when(BTB.io.hit & io.PF_valid & (B_type | J_type)){
        bp_taken := PHT(pht_idx)(BHT(bht_idx) ^ io.PF_pc(7, 4))(0)
    }
    ...
    when(io.ID_to_BPU_bus.valid){
        ...
        PHT(up_pht_idx)(BHT(up_bht_idx) ^ ID_pc(7, 4)) := MuxCase(PHT(up_pht_idx)(BHT(up_bht_idx) ^ ID_pc(7, 4)), Seq(
            (PHT(up_pht_idx)(BHT(up_bht_idx) ^ ID_pc(7, 4)) === PH_State.ST  && !ID_br_taken, PH_State.WT ),
            (PHT(up_pht_idx)(BHT(up_bht_idx) ^ ID_pc(7, 4)) === PH_State.WT  && !ID_br_taken, PH_State.WNT),
            (PHT(up_pht_idx)(BHT(up_bht_idx) ^ ID_pc(7, 4)) === PH_State.WT  &&  ID_br_taken, PH_State.ST ),
            (PHT(up_pht_idx)(BHT(up_bht_idx) ^ ID_pc(7, 4)) === PH_State.WNT &&  ID_br_taken, PH_State.WT ),
            (PHT(up_pht_idx)(BHT(up_bht_idx) ^ ID_pc(7, 4)) === PH_State.WNT && !ID_br_taken, PH_State.SNT),
            (PHT(up_bht_idx)(BHT(up_bht_idx) ^ ID_pc(7, 4)) === PH_State.SNT &&  ID_br_taken, PH_State.SNT)
            ))
