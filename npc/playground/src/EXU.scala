...
class EXU extends Module{
    ...
    ALU_Result := MuxCase(0.U, Seq(
        ...
        (io.ID_optype === OP_SLLW, SEXT((io.ID_ALU_Data1(31, 0) << shamt   ), 32)),
        (io.ID_optype === OP_SRLW, SEXT((io.ID_ALU_Data1(31, 0) >> shamt   ), 32)),
        (io.ID_optype === OP_SRAW, SEXT(((io.ID_ALU_Data1(31, 0).asSInt >> shamt).asUInt), 32)),
