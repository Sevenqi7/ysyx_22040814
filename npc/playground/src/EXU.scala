...
class EXU extends Module{
    ...
    MemWriteData := MuxCase(io.ID_Rs2Data, Seq(
        ...
        (io.WB_RegWriteEn.asBool && (io.WB_RegWriteID === io.ID_Rs2ID && io.ID_Rs2ID > 0.U) && io.ID_MemWriteEn.asBool, io.WB_RegWriteData)
    ))
    ...
    ALU_Data1 := Mux(io.EX_MemReadEn.asBool && (io.EX_RegWriteID === io.ID_Rs1ID) && (io.ID_MemWriteEn.asBool || io.ID_MemReadEn.asBool),
