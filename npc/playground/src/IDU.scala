...
class IDU extends Module{
    ...
    rs1_data := MuxCase(GPR(rs1), Seq(
        ...
        ((io.MEM_RegWriteID === rs1) && (io.MEM_RegWriteEn.asBool || MemWriteEn.asBool), io.MEM_RegWriteData),
    ...
    rs2_data := MuxCase(GPR(rs2), Seq(
        ...
        ((io.MEM_RegWriteID === rs2) && (io.MEM_RegWriteEn.asBool || MemWriteEn.asBool), io.MEM_RegWriteData),
