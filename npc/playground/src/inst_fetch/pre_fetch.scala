...
class IF_pre_fetch extends Module{
    ...
    io.bp_fail := io.ID_npc =/= io.IF_pc && io.IF_pc =/= 0.U && io.ID_npc =/= 0.U

    regConnectWithResetAndStall(io.PF_pc, Mux(!io.bp_fail, io.PF_pc+4.U, io.ID_npc), reset, 0x80000000L.U(64.W), io.stall)
